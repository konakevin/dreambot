...
const s = StyleSheet.create({
  ...
  title: { color: colors.textPrimary, fontSize: fontScale(20), fontWeight: '800' },
  subtitle: {
  ...
  dropdownGrid: { flexDirection: 'row', gap: 12, marginBottom: verticalScale(12) },
  dropdownRow: { flex: 1 },
  dropdownLabel: {
    color: colors.textSecondary,
  ...
  dropdownValue: { color: colors.textPrimary, fontSize: fontScale(14), fontWeight: '600' },
  ...
  confirmTitle: { color: colors.textPrimary, fontSize: fontScale(18), fontWeight: '700' },
  confirmMessage: {
    color: colors.textSecondary,
    fontSize: fontScale(14),
    textAlign: 'center',
  ...
  confirmActions: { flexDirection: 'row', gap: 12, marginTop: verticalScale(12), width: '100%' },
  confirmCancel: {
    flex: 1,
    paddingVertical: verticalScale(12),
    borderRadius: 12,
  ...
  confirmCancelText: { color: colors.textPrimary, fontSize: fontScale(15), fontWeight: '600' },
  confirmDestructive: {
    flex: 1,
    paddingVertical: verticalScale(12),
    borderRadius: 12,
  ...
  confirmDestructiveText: { color: '#FFFFFF', fontSize: fontScale(15), fontWeight: '700' },
  ...
  sendButtonText: { color: colors.textSecondary, fontSize: fontScale(15), fontWeight: '600' },
  ...
  saveButtonText: { color: '#FFFFFF', fontSize: fontScale(17), fontWeight: '700' },
  saveButtonTextDisabled: { color: colors.textSecondary },
  clearButton: { paddingVertical: verticalScale(8), alignItems: 'center' },
  clearButtonText: { color: colors.textSecondary, fontSize: fontScale(14), fontWeight: '600' },
  modLabel: {
    color: colors.textSecondary,
    fontSize: fontScale(13),
  ...
  pickerAvatarText: { color: colors.textPrimary, fontSize: fontScale(16), fontWeight: '700' },
  pickerUsername: {
    flex: 1,
    color: colors.textPrimary,
    fontSize: fontScale(15),
