...
**3×/day** (per-bot, DB-tunable via `bot_schedules.posts_per_day`; fleet-wide set to 3 on
2026-08-06). Cadence is DB-driven: `.github/workflows/bots-dispatcher.yml` (every 15 min) reads
