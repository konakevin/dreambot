...
**2×/day** (per-bot, DB-tunable via `bot_schedules.posts_per_day`; fleet-wide bumped to 2 on
2026-08-06, up from 1×/day set 2026-08-04). Cadence is DB-driven: `.github/workflows/bots-dispatcher.yml` (every 15 min) reads
