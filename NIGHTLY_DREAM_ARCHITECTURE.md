...
> **Progress (2026-05-29):** Phase 1 ✅, Phase 1.5 ✅, Phase 2 ✅ — all deployed. 20-biome taxonomy; all 105 locations on bespoke `biome_config`; assembler (`assembleScene`) is biome-scope-filtered. Remaining: Phase 3 (unify brief branches), Phase 4 (theme/guardrails/QA), + close-outs (named `resolveBiomeForCard` + lazy-gen).
