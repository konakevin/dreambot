...
## Build log
| 2026-08-26 | Wild West 8→5 + Gothic fold | **Wild West:** folded Saloon Interior + Steam Train Depot + Border Cantina (45 cast spots each) into a broadened **Frontier Town** (6 facets), hid the 3 (picker_category=null) → 236 spots. QA found Frontier Town's ORIGINAL spots were THEME-PARK replicas ("Frontier Town replica sheriff's office", "on display track") → rendered MODERN CARS on a paved street. Deactivated 14 replica/heritage spots → 222; R2 verifying. Scene surface 4.4 (moody period street). **Gothic:** folded Cursed Cathedral (55 spots) → Haunted Castle (245), kept Transylvania → gothic 3→2 (both fold into "Fantasy" under 4+4). | Wild West R2 pending; Gothic ✅ |
