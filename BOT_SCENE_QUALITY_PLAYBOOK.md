...
- **BAN "man / woman / male / female / boy / girl / lady / person"** as the identity noun. Gender rides on the **class/role-noun** (sorceress / enchantress / warlord / huntress vs. warlock / sorcerer) and **pronouns** only. ("human" the *race* is fine — it's the age/gender framing that humanizes, not the word "human.")
