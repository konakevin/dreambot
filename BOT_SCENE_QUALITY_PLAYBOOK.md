...
**Pollinators: 1 tiny butterfly in 11 renders.** Not this work (the insect is named at 52-59% of every prompt, past the attention region, on all 125 original entries too). Still open; the fix is prompt order on this template.
