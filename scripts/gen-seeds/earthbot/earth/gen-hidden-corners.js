...
generatePool({
  outPath: 'scripts/bots/earthbot/earth/seeds/hidden_corners.json',
  total: 200,
  batch: 50,
  metaPrompt: (
    n
  ) => `You are writing ${n} INTIMATE DISCOVERED NATURE descriptions for EarthBot — small secret places that feel like personal discoveries, quiet and magical.
