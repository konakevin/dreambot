...
generatePool({
  ...
  batch: 10,
  append: true,
  metaPrompt: (n) => `You are writing ${n} PHENOMENON entries for EarthBot waves. Each entry describes ONE rare optical event woven into the wave scene. 30%-gated conditional axis — fires on minority of renders.
