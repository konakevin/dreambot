...
⚡ CROSSBOW DISTRIBUTION MANDATE: Approximately 10 of the ${n} entries MUST feature a crossbow as the PRIMARY visible weapon. Vary the crossbow type across these 10 — Van-Helsing heavy hunter crossbow, small silver recurve, wrist-mounted crossbow, compact hand-crossbow, siege-style heavy crossbow with stirrup, scoped sniper crossbow, repeating crossbow, ornate gold-and-silver dueling crossbow, crossbow-pistol hybrid, twin small wrist-crossbows. Each of those 10 entries describes a DIFFERENT crossbow flavor — never repeat the same crossbow type twice. The remaining ${Math.max(n - 10, 0)} entries cover OTHER weapons (pistols, swords, axes, whips, daggers, etc.) varied widely.
