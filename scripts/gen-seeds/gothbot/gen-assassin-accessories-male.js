...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `Write ${n} VAMPIRE-ASSASSIN-MALE WEAPON & ACCESSORY descriptions for GothBot. Each entry is 16-26 words. The accessory is the SIGNATURE OBJECT visible at full-body wide-shot — what makes him readable as an assassin from across the frame.
