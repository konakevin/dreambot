...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `You are writing ${n} CITY-SCALE CAMERA ANGLE descriptions for StarBot's alien-city path — cinematic framings specifically designed for vast alien cityscapes. 15-25 words each.
