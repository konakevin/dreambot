...
generatePool({
  outPath: 'scripts/bots/mechbot/seeds/cyborg_male_characters.json',
  total: 200,
  batch: 50,
  metaPrompt: (
    n
  ) => `You are writing ${n} CYBORG MAN face/identity descriptions for StarBot. Each describes ONLY his organic face and which major body regions are mechanical — the brief has SEPARATE pools for skin tone, body type, hair, eyes, internal exposure, and glow color, so do NOT repeat those here.
