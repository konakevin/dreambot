...
generatePool({
  ...
  batch: 18,
  append: true,
  metaPrompt: (n) => `Write ${n} ATMOSPHERIC/WEATHER descriptors for a kawaii Japanese matsuri scene. Each entry describes what's drifting/floating/falling through the AIR.
