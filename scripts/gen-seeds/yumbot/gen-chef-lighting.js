...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `Write ${n} LIGHTING DIRECTION / QUALITY descriptors for a kawaii mini-chef kitchen scene. ONLY how light falls — direction, quality, key/fill, accent. NOT time-of-day.
