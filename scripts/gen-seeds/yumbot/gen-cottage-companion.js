...
generatePool({
  ...
  batch: 18,
  append: true,
  metaPrompt: (n) => `Write ${n} TINY COTTAGECORE COMPANION accents for a kawaii cottagecore-nature scene. Each entry is ONE small peripheral cute creature near the foods.
