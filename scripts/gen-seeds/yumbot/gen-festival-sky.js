...
generatePool({
  ...
  batch: 18,
  append: true,
  metaPrompt: (n) => `Write ${n} OVERHEAD/SKY descriptions for a kawaii Japanese matsuri (festival) scene. Each entry describes ONLY what's overhead — the sky, lantern canopy, festival decorations above the scene.
