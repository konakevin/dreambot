...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `Write ${n} ICONIC COTTAGECORE SIGNATURE elements for a kawaii cottagecore-nature scene. Each entry is ONE specific cottagecore prop or accent that anchors the scene as cottagecore.
