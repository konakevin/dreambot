...
const POOLS = {
  street: { mvp: 25, scale: 200, prompt: (n) => `You are writing ${n} STREET descriptions for PixelBot's pixel-rain-street path: an OLD-TOWN street at dusk or night, the hero of a whimsical, richly detailed pixel-art painting in the register of a classic game's splash screen (think the pretty town scene a 16-bit RPG paints on its title screen). Each entry names ONE focal element as the HERO first (a stone bridge, a lamp post, an ivy arch, a lantern-hung arcade, a lit round window, a stone stair, a wall fountain, a canal-side balcony, a well in a small square). NO SHOPFRONTS AND NO PUBLIC BUILDINGS (Kevin 2026-09-19): a shop face, a bakehouse, a tram stop or a station forecourt makes Flux invent lettered signage on the facades, which is a hard fail, and five rounds of prompt wording could not stop it. Every street here is residential or civic-plain: houses, garden walls, canals, bridges, stairs, arcades and then the street receding into depth behind it: its surface (cobbles, flagstones, worn stone steps, brick), its buildings (their storybook shapes), and ONE charm detail that is a hung or growing object (a lantern on a bracket, a flower box, ivy, a cat on a sill, a rowboat at the steps), never a board, plate, emblem, carved sign or weathervane. 30 to 50 words.
