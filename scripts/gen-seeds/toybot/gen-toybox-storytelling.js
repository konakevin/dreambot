...
FUN > SERIOUS. Funny because they're toys doing absurd grown-up things. A 3.75-inch action-figure knight charging on a Hot Wheels monster truck. Plush bears moshing while army-men try to break it up. Calico Critters hosting tea when a T-rex barges in. Barbies in tactical gear robbing the piggy-bank vault. Funko Pops conducting a courtroom drama. The HUMOR is non-negotiable.
...
**SLOT 1 — REAL SURFACE + STORY SETUP.** Pick the kid-playtime surface AND name the absurd story unfolding. Format: "[surface] — [story setup phrase]." Examples:
  ...
  • "Real coffee table — wedding ceremony in progress between a Barbie and a vintage action-figure knight, with VIPs seated on stacked books"
  ...
  • "Real kid's-bedroom carpet — construction site disaster, the stacked wooden-block tower has just collapsed and chaos reigns"
  ...
  • "Real garage workbench — mad-scientist lab where a Funko Pop inventor's experiment is going dramatically wrong"
...
**SLOT 2 — PROTAGONIST + ABSURD DRAMATIC ACTION.** ONE hero toy doing something hilariously dramatic / silly. Examples:
  • "a 3.75-inch action-figure knight in painted-plastic armor charging on the back of a Hot Wheels monster truck with sword raised heroically"
  ...
  • "a vintage Kenner space-pirate figure mid-walking-the-plank off a stacked-book diving board"
...
**SLOT 3 — 3-5 SUPPORTING CAST each with DISTINCT mischief action across DIFFERENT brand families.** Mix toy types. Each character does something specific. Examples:
  ...
  • "a stitched-Sackboy holding a tiny scoreboard, three plastic-soldier referees blowing tiny whistles, a plush owl-judge on a stacked-book bench, and four green army-men forming a cheerleading pyramid"
...
**SLOT 4 — ABSURD VISUAL GAG / COMEDY PROP DETAIL.** ONE specific tiny detail that makes the scene FUNNIER. Examples:
  ...
  • "a tiny wooden-block 'PLEASE DON'T' tower stacked behind the chaos as a passive-aggressive warning"
...
━━━ ABSOLUTE BANS ━━━
- NO LEGO / Lego / brick-built / studded / blocky-limb minifigs. LEGO belongs to a separate bot. NEVER mention LEGO in any seed — substitute Funko Pop / vintage action figure / Polly Pocket / plush / plastic dinosaur / Power Ranger / Buzz Lightyear / etc. for the same role.
- NO single-medium scenes. EVERY scene mixes 4-6+ DIFFERENT toy mediums (plush + Hot Wheels + Barbie + Funko Pop + GI Joe + army-men + Calico Critter + plastic dinosaur + Polly Pocket + vintage Kenner + etc.).
