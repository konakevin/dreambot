...
generatePool({
  ...
  batch: 15,
  append: true,
  metaPrompt: (n) => `Write ${n} DISTRICT / NEIGHBORHOOD entries for a MangaBot neo-tokyo cyberpunk anime keyframe. Each entry is the SPECIFIC CYBERPUNK BIOME the scene sits in — different neighborhoods of neo-tokyo have very different feels.
