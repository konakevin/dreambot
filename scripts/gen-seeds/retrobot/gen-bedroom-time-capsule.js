...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `You are writing ${n} BEDROOM TIME CAPSULE scene descriptions for RetroBot — a kid's bedroom frozen in time, 1975-1995. No people visible. Pure scene/environment.
