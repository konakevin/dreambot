...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `You are writing ${n} MALL HANGOUT scene descriptions for RetroBot — the American shopping mall as social hub, 1980-1995. No people visible. Pure scene/environment.
