...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `You are writing ${n} TINY COZY SCENE descriptions for TinyBot's tiny-cozy path — warm-inviting-homey dollhouse-scale scenes. Viewer wants to shrink down and LIVE here.
