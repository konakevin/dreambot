...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `You are writing \${n} ENVIRONMENTAL PHENOMENA for ChibiBot twilight-village — atmospheric/weather/magical layers that fire on 60% of renders, adding a wow-moment.
