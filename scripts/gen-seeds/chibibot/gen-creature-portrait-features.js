...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `You are writing ${n} CUTE PORTRAIT FEATURES for ChibiBot creature-portrait — small cute amplifier-details visible on the chibi creature's body/face in a tight portrait. Template picks 2 per render.
