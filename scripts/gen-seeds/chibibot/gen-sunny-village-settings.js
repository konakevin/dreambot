...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `You are writing \${n} SUNNY-VILLAGE SETTINGS for ChibiBot sunny-village — cozy sunny-biome villages that are the HERO of the frame. NOT a single cottage — a VILLAGE (cluster of multiple dwellings).
