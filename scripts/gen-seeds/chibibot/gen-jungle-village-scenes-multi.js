...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `You are writing ${n} MULTI-CHARACTER JUNGLE-VILLAGE scenes for ChibiBot's jungle-village path. The pool already has 390 single-creature scenes — your job is to add PAIR + TRIO scenes for character variance.
