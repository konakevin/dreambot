...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `You are writing \${n} COTTAGECORE-VILLAGE ACTIVITIES for ChibiBot cottagecore-village — what a small peripheral creature is doing in the cottagecore village foreground. Story-beat actions.
