...
generatePool({
  ...
  total: 200,
  batch: 25,
  metaPrompt: (n) => `You are writing \${n} AQUATIC-VILLAGE ACTIVITIES for ChibiBot aquatic-village — what a small peripheral creature is doing in the aquatic village foreground. Story-beat actions.
