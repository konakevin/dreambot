...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `You are writing \${n} SURPRISE-ELEMENT descriptions for ChibiBot aquatic-village — tiny second-tier details the eye finds after the village + foreground creature.
