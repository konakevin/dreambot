...
generatePool({
  ...
  total: 50,
  batch: 25,
  metaPrompt: (n) => `You are writing ${n} ENVIRONMENTAL PHENOMENA for ChibiBot rainy-day-cozy — magical or atmospheric events that crank drama when they fire (60%-gated).
