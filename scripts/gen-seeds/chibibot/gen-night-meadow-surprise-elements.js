...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `You are writing ${n} SURPRISE-ELEMENT descriptions for ChibiBot night-meadow scenes — tiny secondary subjects or ambient nighttime details the eye finds AFTER the cuddling pair. The pair is the main subject; the surprise element is the second-tier detail that proves there's a bigger magical-nighttime world.
