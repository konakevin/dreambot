...
generatePool({
  ...
  total: 200,
  batch: 25,
  metaPrompt: (n) => `You are writing \${n} COTTAGECORE-VILLAGE SETTINGS for ChibiBot cottagecore-village — cozy cottagecore-biome villages that are the HERO of the frame. NOT a single cottage — a VILLAGE (cluster of multiple dwellings).
