...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `You are writing ${n} WILDERNESS DETAILS for ChibiBot outdoor-adventure — small wilderness details scattered through the scene that make the wild place feel lived-in by nature. Template picks 3 per render.
