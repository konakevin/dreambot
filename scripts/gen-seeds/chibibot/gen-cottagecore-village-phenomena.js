...
generatePool({
  ...
  total: 100,
  batch: 25,
  metaPrompt: (n) => `You are writing \${n} ENVIRONMENTAL PHENOMENA for ChibiBot cottagecore-village — atmospheric/weather/magical layers that fire on 60% of renders, adding a wow-moment.
