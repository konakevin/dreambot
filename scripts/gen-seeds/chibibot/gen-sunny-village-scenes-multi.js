...
generatePool({
  ...
  append: true,
  batch: 50,
  metaPrompt: (n) => `You are writing ${n} MULTI-CHARACTER SUNNY-VILLAGE scenes for ChibiBot's sunny-village path. The pool already has 200 single-creature scenes — your job is to add PAIR + TRIO village scenes so renders vary character count.
