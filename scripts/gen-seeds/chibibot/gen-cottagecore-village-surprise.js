...
generatePool({
  ...
  total: 100,
  batch: 25,
  metaPrompt: (n) => `You are writing \${n} SURPRISE-ELEMENT descriptions for ChibiBot cottagecore-village — tiny second-tier details the eye finds after the village + foreground creature.
