...
generatePool({
  ...
  batch: 50,
  append: true,
  metaPrompt: (n) => `You are writing ${n} SURPRISE-ELEMENT descriptions for ChibiBot bath-time scenes — tiny secondary subjects or ambient details the eye finds AFTER the hero creature(s). The hero creature is the main subject; the surprise element is the second-tier detail that proves there's a bigger world.
