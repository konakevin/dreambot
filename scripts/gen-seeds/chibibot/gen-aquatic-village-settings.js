...
generatePool({
  ...
  total: 200,
  batch: 25,
  metaPrompt: (n) => `You are writing \${n} AQUATIC-VILLAGE SETTINGS for ChibiBot aquatic-village — cozy aquatic-biome villages that are the HERO of the frame. NOT a single cottage — a VILLAGE (cluster of multiple dwellings).
