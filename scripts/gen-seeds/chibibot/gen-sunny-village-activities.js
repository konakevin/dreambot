...
generatePool({
  ...
  total: 200,
  batch: 25,
  metaPrompt: (n) => `You are writing \${n} SUNNY-VILLAGE ACTIVITIES for ChibiBot sunny-village — what a small peripheral creature is doing in the sunny village foreground. Story-beat actions.
