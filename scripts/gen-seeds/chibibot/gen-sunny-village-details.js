...
generatePool({
  ...
  total: 200,
  batch: 25,
  metaPrompt: (n) => `You are writing \${n} SUNNY-VILLAGE DETAILS for ChibiBot sunny-village — small lived-in details scattered across the village that make it feel inhabited. Template picks 3 per render.
