...
generatePool({
  ...
  metaPrompt: (
    n
  ) => `You are writing ${n} MULTI-CREATURE aquatic entries for ChibiBot's cuddly-aquatic path. The pool already has 340 SOLO entries — your job is to add PAIR and TRIO entries so renders vary character count.
