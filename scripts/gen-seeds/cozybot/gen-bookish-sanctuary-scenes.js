...
generatePool({
  outPath: 'scripts/bots/cozybot/seeds/bookish_sanctuary_scenes.json',
  total: 100,
  batch: 25,
  metaPrompt: (n) => `You are writing ${n} BOOKISH-SANCTUARY scene descriptions for CozyBot — but these are CONCEPT ART of impossibly book-saturated spaces, NOT real libraries. Painterly storybook illustration, never photography. 25-45 words each. NO PEOPLE.
