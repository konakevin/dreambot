...
generatePool({
  outPath: 'scripts/bots/cozybot/seeds/cozy_lights.json',
  total: 60,
  batch: 20,
  metaPrompt: (n) => `You are writing ${n} COZY LIGHTING descriptions for CozyBot — specific warm light sources that act as the dominant illumination of a scene. 15-30 words each.
