...
generatePool({
  outPath: 'scripts/bots/cozybot/seeds/rainy_interior_scenes.json',
  total: 100,
  batch: 25,
  metaPrompt: (n) => `You are writing ${n} RAINY-INTERIOR scene descriptions for CozyBot — but these are CONCEPT ART of impossibly cozy spaces, NOT real rooms. Painterly storybook illustration, never photography. 25-45 words each. NO PEOPLE.
