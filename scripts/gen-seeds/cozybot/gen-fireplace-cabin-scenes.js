...
generatePool({
  outPath: 'scripts/bots/cozybot/seeds/fireplace_cabin_scenes.json',
  total: 100,
  batch: 25,
  metaPrompt: (n) => `You are writing ${n} FIREPLACE-CABIN scene descriptions for CozyBot — but these are CONCEPT ART of impossibly cozy cabins, NOT real cabins. Painterly storybook illustration, never photography. 25-45 words each. NO PEOPLE.
