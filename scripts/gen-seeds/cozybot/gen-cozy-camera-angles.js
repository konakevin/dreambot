...
generatePool({
  outPath: 'scripts/bots/cozybot/seeds/cozy_camera_angles.json',
  total: 50,
  batch: 25,
  metaPrompt: (n) => `You are writing ${n} CAMERA ANGLE / SHOT FRAMING descriptions for CozyBot — composition guides that frame cozy interiors and seasonal exteriors as paintings, not photos. 15-25 words each.
