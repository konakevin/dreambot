...
generatePool({
  outPath: 'scripts/bots/cozybot/seeds/cozy_indoor_lights.json',
  total: 60,
  batch: 20,
  metaPrompt: (n) => `You are writing ${n} INDOOR COZY LIGHTING descriptions for CozyBot — specific warm interior light sources that act as the dominant or accent lighting of a painted-storybook-illustration interior scene. 18-32 words each.
