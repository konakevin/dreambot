...
generatePool({
  outPath: 'scripts/bots/cozybot/seeds/cozy_atmospheres.json',
  total: 60,
  batch: 20,
  metaPrompt: (n) => `You are writing ${n} COZY ATMOSPHERIC DETAIL descriptions for CozyBot — the haze, dust, steam, condensation, smoke, particles in the air that make a room feel TANGIBLY warm. 15-30 words each.
