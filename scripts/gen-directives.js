...
const MEDIUMS = [
  { key: 'pixels', label: 'Pixel Art', refs: '16-bit SNES era, Chrono Trigger, Secret of Mana, Celeste, Hyper Light Drifter' },
  ...
  { key: 'canvas', label: 'Oil Painting', refs: 'Classical oil painting, Rembrandt, Vermeer, impasto, glazing, chiaroscuro, palette knife, visible brushstrokes on canvas' },
  ...
  { key: 'animation', label: '3D Cartoon', refs: 'Pixar/DreamWorks/Illumination stylized 3D, Zootopia, Inside Out, Despicable Me, exaggerated proportions, appealing character design' },
  ...
  { key: 'neon', label: 'Cyberpunk', refs: 'Blade Runner, Ghost in the Shell cityscapes, neon-soaked rain, cybernetic augmentation, Akira, Cyberpunk 2077' },
  { key: 'comics', label: 'Comic Book', refs: 'Marvel/DC comic art, Jim Lee, Todd McFarlane, bold ink outlines, Ben-Day dots, halftone, graphic novel illustration' },
  ...
  { key: 'claymation', label: 'Sack Boy', refs: 'LittleBigPlanet, knitted fabric puppet, craft materials world, cardboard, felt, buttons, zipper, handmade miniature everything' },
  { key: 'vinyl', label: 'Funko Pop', refs: 'Funko Pop vinyl collectible figure, oversized head, tiny body, dot eyes, no mouth, glossy plastic, product photography' },
  ...
  { key: 'gothic', label: 'Tim Burton', refs: 'Nightmare Before Christmas, Corpse Bride, Edward Scissorhands, gothic whimsy, spiral motifs, elongated thin figures, black/white stripes' },
  ...
  { key: 'storybook', label: "Children's Book", refs: 'Caldecott Medal winners, Eric Carle, Maurice Sendak, Oliver Jeffers, hand-painted warmth, gentle storybook illustration' },
