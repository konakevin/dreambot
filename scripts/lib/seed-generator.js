...
const BOT_SEEDS = {
  ...
  mangabot: {
    strategies: [
      { category: 'mangabot_genre', prompt: 'an extremely interesting and visually appealing anime scene inspired by worlds like studio ghibli, makoto shinkai, demon slayer, spirited away, evangelion, princess mononoke — characters can naturally exist in the scene described only by their role (a warrior, a girl, a spirit, a creature) never by name or specific appearance. Include creatures, architecture, magical elements as fits.' },
      { category: 'mangabot_genre_dedup', prompt: 'an extremely interesting and visually appealing anime scene inspired by worlds like studio ghibli, makoto shinkai, demon slayer, spirited away, evangelion, princess mononoke — characters can naturally exist in the scene described only by their role (a warrior, a girl, a spirit, a creature) never by name or specific appearance. Include creatures, architecture, magical elements as fits.', continueDedup: true },
      { category: 'mangabot_landscape', prompt: 'a beautiful Japanese anime world that is visually stunning, warm and inviting, interesting to explore. Pure environment, no characters.', separateDedup: true },
      { category: 'mangabot_cute', prompt: 'an adorable heartwarming anime scene inspired by the feeling of totoro, ponyo, kiki — characters exist naturally described only by role (a girl, a spirit, a cat, a creature) never by name or appearance details. Big expressive eyes, warm cozy atmosphere.', separateDedup: true },
    ],
  },
  starbot: {
    strategies: [
