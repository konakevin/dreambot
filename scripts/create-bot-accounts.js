...
const BOTS = [
  // ── Art Accounts (stunning content) ──
  {
    ...
    art_styles: ['oil_painting', 'fantasy', 'photorealistic'],
  ...
  },
  {
    ...
    art_styles: ['surreal', '3d_render', 'cyberpunk'],
  ...
  },
  {
    ...
    art_styles: ['watercolor', 'oil_painting', 'ghibli'],
  ...
  },
  {
    ...
    art_styles: ['photorealistic', 'oil_painting', 'surreal'],
  ...
  // ── Culture & Style Accounts ──
  {
    ...
    art_styles: ['anime', 'ghibli', 'cyberpunk'],
  ...
  },
  {
    ...
    art_styles: ['lego', 'pixel_art', 'claymation', '3d_cartoon', 'tim_burton', 'paper_cutout', 'embroidery', 'retro_poster', 'art_deco', 'steampunk', 'vaporwave', '8bit', 'minecraft', 'sack_boy', 'funko_pop', 'disney', 'comic_book', '3d_render', 'childrens_book'],
  ...
  },
  {
    ...
    art_styles: ['tim_burton', 'fantasy', 'steampunk', 'anime'],
  ...
  },
  {
    ...
    art_styles: ['3d_cartoon', 'claymation', 'disney', 'childrens_book'],
  ...
  },
  {
    ...
    art_styles: ['pixel_art', '8bit', 'vaporwave'],
  ...
  },
  {
    ...
    art_styles: ['comic_book', 'retro_poster', 'art_deco'],
