...
const ARCHETYPES = [
  {
    ...
    flavor_keywords: ['kitchen', 'cooking', 'baking', 'steam', 'warmth', 'comfort food', 'spices', 'recipe'],
  },
  {
    key: 'ocean_dreamer',
    name: 'The Ocean Dreamer',
    description: 'Endless horizons, deep water mysteries, the sound of waves, salt air, tide pools.',
    ...
    flavor_keywords: ['waves', 'coral', 'deep water', 'tide', 'salt', 'current', 'bioluminescent', 'shore'],
  },
  {
    key: 'vinyl_dreamer',
    ...
    flavor_keywords: ['vinyl', 'melody', 'strings', 'notes', 'rhythm', 'concert', 'instrument', 'headphones'],
  },
  {
    key: 'neon_gamer',
    name: 'The Neon Gamer',
    ...
    flavor_keywords: ['pixel', 'neon', 'controller', 'level', 'quest', 'arcade', 'power-up', 'respawn'],
  },
  {
    key: 'cosmic_voyager',
    ...
    flavor_keywords: ['nebula', 'orbit', 'starlight', 'gravity', 'cosmos', 'probe', 'constellation', 'void'],
  },
  {
    key: 'dark_mystic',
    ...
    flavor_keywords: ['shadow', 'candle', 'gothic', 'raven', 'moonlit', 'obsidian', 'velvet', 'ancient'],
  },
  {
    key: 'kawaii_spirit',
    name: 'The Kawaii Spirit',
    description: 'Pastel everything, tiny creatures, sparkles, heart-shaped clouds, maximum cuteness.',
    ...
    flavor_keywords: ['tiny', 'sparkle', 'pastel', 'fluffy', 'kawaii', 'miniature', 'adorable', 'plush'],
  },
  {
    key: 'wild_explorer',
    ...
    flavor_keywords: ['trail', 'summit', 'campfire', 'wilderness', 'horizon', 'expedition', 'dawn', 'cliff'],
  },
  {
    ...
    flavor_keywords: ['enchanted', 'potion', 'crystal', 'spell', 'dragon', 'castle', 'ancient', 'magical'],
  },
  {
    key: 'retro_romantic',
    name: 'The Retro Romantic',
    description: 'Old photographs, handwritten letters, vintage shops, the beauty of things that age.',
    ...
    flavor_keywords: ['vintage', 'polaroid', 'typewriter', 'sepia', 'film grain', 'handwritten', 'antique', 'faded'],
  },
  {
    key: 'urban_poet',
    name: 'The Urban Poet',
    description: 'City lights, rooftop views, street art, rain on concrete, the rhythm of the city.',
    ...
    flavor_keywords: ['neon', 'concrete', 'graffiti', 'rooftop', 'subway', 'rain-slicked', 'streetlight', 'skyline'],
  },
  {
    ...
    flavor_keywords: ['den', 'nest', 'paw prints', 'feathers', 'burrow', 'migration', 'forest floor', 'whiskers'],
  },
  {
    key: 'adrenaline_ace',
    ...
    flavor_keywords: ['velocity', 'peak', 'mid-air', 'arena', 'finish line', 'explosion', 'trophy', 'thunder'],
  },
  {
    key: 'pride_phoenix',
    ...
    flavor_keywords: ['rainbow', 'glitter', 'parade', 'confetti', 'pride', 'color burst', 'dance', 'celebration'],
  },
  {
    ...
    flavor_keywords: ['silk', 'velvet', 'runway', 'couture', 'vintage', 'fabric', 'pattern', 'stitch'],
  },
  {
    key: 'cinema_soul',
    ...
    flavor_keywords: ['cinema', 'spotlight', 'film reel', 'director', 'screenplay', 'montage', 'closeup', 'credits'],
  },
];
    ...
    if (matches.length > 0) {
      ...
      if (rows.length > 0) {
        ...
        if (error) {
          ...
          console.log(
            `  ${user.user_id}: ${matches.map((m) => `${m.key}(${m.hits})`).join(', ')}`
          );
        }
      }
    } else {
