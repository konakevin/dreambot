...
━━━ EVERYONE IN THE SCENE IS FAE — HARD RULE ━━━
EVERY human-scale figure anywhere in the frame — foreground AND background, and every figure on a bridge, path, stair, ledge, stepping-stone or platform — is a slender ELF or tiny FAE in flowing elven/fairy robes. If you place ANY figures crossing a bridge, hopping stepping-stones or walking a path, name them EXPLICITLY as graceful robed elves or fae — never leave a foreground figure unstated (an unstated figure renders as a modern present-day tourist in streetwear, which RUINS the scene). Painted-fantasy fae folk in flowing robes ONLY: NO present-day people, NO contemporary streetwear, NO tourists/hikers/visitors.
...
━━━ EVERYONE IN THE SCENE IS FAE — HARD RULE ━━━
EVERY human-scale figure anywhere in the frame — foreground AND background, and every figure on a bridge, archway, path, stair or balcony — is a slender ELF or tiny FAE in flowing elven/fairy robes. If you place ANY figures crossing a bridge or walking a path, name them EXPLICITLY as graceful robed elves or fae — never leave a foreground figure unstated (an unstated figure renders as a modern present-day tourist in streetwear, which RUINS the scene). Painted-fantasy fae folk in flowing robes ONLY: NO present-day people, NO contemporary streetwear, NO tourists/hikers/visitors.
...
━━━ EVERYONE IN THE SCENE IS FAE — HARD RULE ━━━
EVERY human-scale figure anywhere in the frame — foreground AND background, and every figure on a bridge, archway, path, stair or terrace — is a slender ELF or tiny FAE in flowing elven/fairy robes. If you place ANY figures crossing a bridge or walking a path, name them EXPLICITLY as graceful robed elves or fae — never leave a foreground figure unstated (an unstated figure renders as a modern present-day tourist in streetwear, which RUINS the scene). Painted-fantasy fae folk in flowing robes ONLY: NO present-day people, NO contemporary streetwear, NO tourists/hikers/visitors.
