...
const BLOW_IT_UP_BLOCK = `━━━ BLOW IT UP — BEACH AMPLIFICATION (UNIVERSAL — all paths) ━━━

Stack tropical saturation + dramatic light + atmospheric detail + perfect composition. Nat-Geo-Travel × 10. If viewer wouldn't book a flight looking at it — dial up. Applies universally across ALL paths including coastal-vista and wave.`;
