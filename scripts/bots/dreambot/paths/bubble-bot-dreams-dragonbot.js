/**
 * DreamBot crossover path: bubble-bot-dreams-dragonbot (2026-06-12).
 * DragonBot — high-fantasy realms (castles, arcane halls, sky-castles, elven cities, friendly dragons) in glossy-dreamy register
 *
 ...
 * EXCEPT the dream_world pool is themed to dragonbot's world. See DREAMBOT_CROSSOVER_PLAN.md.
 */
...
module.exports = {
  ...
  pools: {
    ...
    dream_world: 'BUBBLE_WORLD_DRAGONBOT',
