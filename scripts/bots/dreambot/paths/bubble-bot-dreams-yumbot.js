/**
 * DreamBot crossover path: bubble-bot-dreams-yumbot (2026-06-12).
 * The bubble-bot in yumbot's world, rendered in DreamBot's glossy-dreamy register.
...
module.exports = {
  ...
  pools: {
    ...
    dream_world: 'BUBBLE_WORLD_YUMBOT',
