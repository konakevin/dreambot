/**
 * DreamBot crossover path: bubble-bot-dreams-brickbot (2026-06-12).
 * BrickBot — all-LEGO brick-built worlds (pirate/castle/city/space/diorama) in glossy-dreamy register
 *
 ...
 * EXCEPT the dream_world pool is themed to brickbot's world. See DREAMBOT_CROSSOVER_PLAN.md.
 */
...
module.exports = {
  ...
  pools: {
    ...
    dream_world: 'BUBBLE_WORLD_BRICKBOT',
