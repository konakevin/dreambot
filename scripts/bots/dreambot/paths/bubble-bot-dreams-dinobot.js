/**
 * DreamBot crossover path: bubble-bot-dreams-dinobot (2026-06-12).
 * The bubble-bot in dinobot's world, rendered in DreamBot's glossy-dreamy register.
...
module.exports = {
  ...
  pools: {
    ...
    dream_world: 'BUBBLE_WORLD_DINOBOT',
