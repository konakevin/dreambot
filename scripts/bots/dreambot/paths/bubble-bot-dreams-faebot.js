/**
 * DreamBot crossover path: bubble-bot-dreams-faebot (2026-06-12).
 * The bubble-bot in faebot's world, rendered in DreamBot's glossy-dreamy register.
...
module.exports = {
  ...
  pools: {
    ...
    dream_world: 'BUBBLE_WORLD_FAEBOT',
