/**
 * DreamBot crossover path: bubble-bot-dreams-steambot (2026-06-12).
 * The bubble-bot in steambot's world, rendered in DreamBot's glossy-dreamy register.
...
module.exports = {
  ...
  pools: {
    ...
    dream_world: 'BUBBLE_WORLD_STEAMBOT',
