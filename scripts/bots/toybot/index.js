...
module.exports = {
  ...
  mediumStyles: {
    ...
    dollhouse_figures:
      'dollhouse-scale miniature figurine in a fully-appointed handcrafted miniature interior — could be a flocked Calico-Critter-style small-animal, a vintage wooden / soft-plastic dollhouse-people figure, or a modern Lori / Lottie-style posable fashion-doll-scale human, painted faces, tiny cloth outfits, wooden furniture / tiny dishware / mini books / hand-sewn drapes / miniature appliances at scale, shallow-depth miniature-photography, warm window-glow or lamp-glow lighting, cozy wholesome daily-life energy — NOT real human NOT real animal NOT CGI NOT illustration',
    shortcake_figures:
    ...
    hot_wheels:
      'Hot Wheels / Micro Machines die-cast toy-car aesthetic — 1:64-scale (~3-inch) die-cast metal-and-plastic toy car with chrome accents, glossy paint, oversized hot-rod-style wheels, racing-stripes or flame-decals, visible mold-seam underneath, signature ORANGE Hot-Wheels-style flexible-snap-track segments (curve / loop / launcher / jump-ramp pieces), real-world-object surroundings (bookshelf canyon, kitchen-sink ocean, bathtub waterfall, garage-floor megaramp, rooftop city) photographed from extreme low macro angle to make 3-inch cars feel epic, speed-blur on tires, dust-puff under wheels, headlight cones cutting through shadow, bright die-cast-car-commercial cinematic energy — NOT real car NOT 1:18-scale collector NOT CGI NOT illustration',
    model_train_diorama:
      'HO-scale (1:87) or N-scale model-railroad diorama aesthetic — tiny die-cast steam locomotive or diesel engine pulling boxcars / passenger cars / coal-tenders / cabooses on twin nickel-silver rails, hand-built terrain features (ground foam, lichen trees, plaster-cast rock-faces, static-grass meadows, scratch-built brick depots, signal-towers, water-tower, level-crossing, lift-bridge), NO HUMAN FIGURES in frame, train as focal point or ambient detail in richly-detailed terrain, visible model-railroad construction tells (raised baseboard edge OK), wide-diorama framing, hobby-shop / display-table lighting per pool palette, lit windows in tiny depot, smoke from engine stack, atmospheric haze in valleys, cozy obsessive-detail energy — NEVER real train NEVER CGI NEVER illustration NEVER scale-people-figures filling frame',
    plush_fabric:
      'plush stuffed-animal aesthetic — soft-fabric stuffed-animal characters (teddy bear / plush bunny / stuffed fox / knitted cat / stitched dragon / fabric owl / felt duck / cuddly raccoon) with visible plush-fiber FUR or KNIT TEXTURE, embroidered or button eyes, stitched mouth, sewn-on muzzle, soft floppy limbs, fiberfill pudgy bodies, optional tiny knit sweaters or cloth bandanas, photographed in a fully-dressed handcrafted miniature set (forest campsite, sailboat, picnic meadow, attic bedroom, treehouse), warm firelight / lantern-glow / golden-hour-meadow / moonlit-window practical lighting per pool palette, shallow-depth-of-field storybook warmth — NOT LBP burlap-with-zipper (that is Sackboy) NOT real animal NOT CGI NOT illustration',
    mech_toys:
      'articulated mech-toy aesthetic — robot-toy / Gundam-style model-kit / transforming-mech-toy with visible ball-joint articulation at neck / shoulders / elbows / wrists / hips / knees / ankles, chrome-plated paneling and armor plates, visible transformation seams (line-cuts where panels would fold/flip), cockpit-canopy with glowing tinted plastic, hand-painted weathering / battle-damage / panel-line wash, snap-on weapon accessories (energy-sword / plasma-rifle / shield / shoulder-cannon / missile-pod), 1/144 to 1/100 collector scale, archetypes (humanoid mecha / transforming car-mecha / beast-form mecha — lion / tiger / wolf / dragon mech / powered-armor exosuit), real-physical-toy on a handcrafted set, mecha-anime-toy-line dramatic low-angle hero composition, chrome reflections, cockpit-glow, sparks-flying, missile-trail haze — NEVER IP-named NEVER CGI NEVER illustration',
  },
