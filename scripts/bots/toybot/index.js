 ...
 * `stitched` and `action_figure` (NOT in public dream_mediums table — same
...
module.exports = {
  ...
  // `stitched` + `action_figure` are bot-only mediums
  mediumByPath: {
    'lego-epic': 'lego',
