...
module.exports = {
  ...
  MERMAID_LEGEND_SCENES: load('mermaid_legend_scenes'),
  MERMAID_LEGEND_MOMENTS: load('mermaid_legend_moments'),
  MERMAID_LEGEND_ACTIONS: load('mermaid_legend_actions'),
  MERMAID_HAIR: load('mermaid_hair'),
  MERMAID_HAIR_COLORS: load('mermaid_hair_colors'),
  MERMAID_HAIR_STYLES: load('mermaid_hair_styles'),
  MERMAID_TAIL_COLORS: load('mermaid_tail_colors'),
  MERMAID_TAIL_STYLES: load('mermaid_tail_styles'),
  MERMAID_COVERINGS: load('mermaid_coverings'),
