...
Mixed bot. Breathtaking steampunk worlds — brass + copper + clockwork +
Victorian-industrial. BioShock-Infinite / Mortal-Engines / Hugo / Howl's-
Moving-Castle / FFIX energy. Obsessive gear/rivet/steam-wisp detail.
Characters by role.
...
`canvas`, `photography`, `illustration`.

## Running

```bash
node scripts/iter-bot.js --bot steambot --count 5 --mode random --label smoke
node scripts/run-bot.js --bot steambot
```
