...
The ethnicity-noun-phrase at the head of the skin entry IS the opening of your prompt — copy it verbatim, IMMEDIATELY followed by her HAIR COLOR ("a Norwegian woman with windswept strawberry-blonde hair…"). (All DNA elements should be discernible in the render. Face fully visible.)
...
ALWAYS name her hair COLOR explicitly, placed in the OPENING right after the ethnicity-noun ("a Yoruba woman with close-cropped black hair…", "an Irish woman with wind-torn copper-red hair…"). NEVER omit hair color. The color MUST be natural for her heritage: blonde / strawberry / red / ginger / auburn / ash / light-brown / silver-grey for Northern & Eastern European heritages (Norwegian, Swedish, Finnish, Icelandic, Irish, Scottish, English, German, Polish, Russian, Ukrainian); black / dark-brown for most other heritages (with natural grey/silver for older women of any heritage). If the DNA hair-color slot conflicts with her heritage, OVERRIDE it to a natural shade — and for fair-skinned European heritages lean into the LIGHTER end (blonde / red / auburn), because the failure mode we are fixing is EVERY woman rendering as a dark brunette. Hair color should visibly differ from render to render. Then render the hair as ALIVE in the moment — whipping in storm-wind, escaping its braid, billowing under flight goggles, torn loose by cannon-recoil. NEVER flat / static. The hair carries the motion of the action.
