/**
 * AlphaBot archetypes — the non-robot paths moved from DreamBot (2026-07-07 split, ALPHABOT.md).
 *
 ...
 * (ChibiBot still owns them). Names keep the DREAMBOT_ prefix — the moved path files reference them and the registry is name-global.
 *
