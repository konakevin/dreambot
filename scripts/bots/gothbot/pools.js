...
module.exports = {
  ...
  // ─── the-sanctum path (2026-06-10 NEW — GRAND COLD gothic INTERIOR as hero; architecture turned inward)
  GOTHBOT_SANCTUM_INTERIOR: loadOptional('gothbot_sanctum_interior'),
  GOTHBOT_SANCTUM_DETAIL: loadOptional('gothbot_sanctum_detail'),
  GOTHBOT_SANCTUM_INNER_LIGHT: loadOptional('gothbot_sanctum_inner_light'),
  GOTHBOT_SANCTUM_FOCAL_FEATURE: loadOptional('gothbot_sanctum_focal_feature'),
  GOTHBOT_SANCTUM_ATMOSPHERE: loadOptional('gothbot_sanctum_atmosphere'),
  GOTHBOT_SANCTUM_ACCENT: loadOptional('gothbot_sanctum_accent'),
  // ─── the-frost-garden path (2026-06-10 NEW — cursed frozen gothic garden / conservatory, place-as-hero)
  GOTHBOT_FROSTGARDEN_GARDEN: loadOptional('gothbot_frostgarden_garden'),
  GOTHBOT_FROSTGARDEN_FLORA: loadOptional('gothbot_frostgarden_flora'),
  GOTHBOT_FROSTGARDEN_FROST_FEATURE: loadOptional('gothbot_frostgarden_frost_feature'),
  GOTHBOT_FROSTGARDEN_STATUARY: loadOptional('gothbot_frostgarden_statuary'),
  GOTHBOT_FROSTGARDEN_LIGHT_SKY: loadOptional('gothbot_frostgarden_light_sky'),
  GOTHBOT_FROSTGARDEN_ACCENT: loadOptional('gothbot_frostgarden_accent'),
  // ─── twilight-gothic path (2026-06-10 NEW — gothic scene at the magic hour; dawn/dusk/golden-hour/fog)
  GOTHBOT_TWILIGHT_SCENE: loadOptional('gothbot_twilight_scene'),
  GOTHBOT_TWILIGHT_LIGHT: loadOptional('gothbot_twilight_light'),
  GOTHBOT_TWILIGHT_SKY: loadOptional('gothbot_twilight_sky'),
  GOTHBOT_TWILIGHT_ATMOSPHERE: loadOptional('gothbot_twilight_atmosphere'),
  GOTHBOT_TWILIGHT_FOREGROUND: loadOptional('gothbot_twilight_foreground'),
  GOTHBOT_TWILIGHT_ACCENT: loadOptional('gothbot_twilight_accent'),
  // ─── the-dark-prince path (2026-06-10 NEW — MALE vampire-lord/cursed-prince bust portrait; male vampire-girls-2)
  DARKPRINCE_ARCHETYPE: loadOptional('darkprince_archetype'),
  DARKPRINCE_ETHNICITY: loadOptional('darkprince_ethnicity'),
  DARKPRINCE_HAIR: loadOptional('darkprince_hair'),
  DARKPRINCE_WARDROBE: loadOptional('darkprince_wardrobe'),
  DARKPRINCE_MENACE: loadOptional('darkprince_menace'),
