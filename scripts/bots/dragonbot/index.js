...
module.exports = {
  ...
  promptPrefixByPath: {
    ...
    // 2026-05-13 Phase 2 — armor_style and weapon are now independent rolled
    // axes (artsy-girl path file). The wrapper no longer needs to enumerate
    // variety inline — the specific armor + weapon are described in the
    // Sonnet body downstream. Wrapper just sets painterly aesthetic + race
    // lock + scene framing.
    'artsy-girl':
      'Frank Frazetta + Brom + Boris Vallejo + Greg Hildebrandt + Michael Whelan painted-fantasy-novel-cover oil tradition, a single heroic WOMAN of a SPECIFIC NON-DEFAULT-HUMAN fantasy lineage — render the race anatomy and tone as the ABSOLUTE FIRST visual property (drow = obsidian skin OR dragonborn = scaled face OR tiefling = horns AND red/violet skin OR orc = green skin AND tusks OR night-elf = purple skin AND glowing silver eyes OR blood-elf = glowing fel-green eyes OR aasimar = alabaster with inner glow OR genasi = elemental-tinted skin) — race is NEVER a pale-European-woman default, at 25-40% of frame full body mid-action wearing her SPECIFIC exotic fantasy armor and wielding her SPECIFIC signature weapon EXACTLY as described in the scene, CANDID PEACEFUL ADVENTURING moment between battles (NO combat NO violence — weapons holstered or being maintained), epic fantasy landscape as her stage, painterly atmospheric grandeur, LOTR + GoT + Elden Ring + Skyrim + Witcher visual lineage, awe-inducing concept-art masterwork',
  },
