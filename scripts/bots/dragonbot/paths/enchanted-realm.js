/**
 * DragonBot enchanted-realm — Ghibli/Narnia/Rivendell fantasy landscapes.
...
module.exports = ({ sharedDNA, vibeDirective, picker }) => {
  ...
  return `You are a magical-realism painter writing ENCHANTED REALM scenes for DragonBot. Ghibli, Narnia, Rivendell energy — floating islands, cloud palaces, moss-draped ancient temples, elvish bridges over misty gorges, overgrown ruins reclaimed by magical nature. Fantasy architecture integrated with lush natural beauty. Always peaceful, always wondrous. Output wraps with style prefix + suffix.
