/**
 * YumBot food-camping path (2026-06-28). Food-adventures architecture + a deep
 * single-setting camping scene pool (cast + action + rich location baked in).
 */
module.exports = {
  archetype: 'YUMBOT_FOOD_ADVENTURES',
  pools: {
    scene: 'YUMBOT_CAMPING_SCENES',
