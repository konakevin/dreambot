...
module.exports = {
  ...
  // 2026-07-03 (off-brand vibe audit) — surreal / psychedelic / arcane /
  // enchanted cut from every path EXCEPT alien-biomechs (Giger register,
  // deliberately kept): fairy-tale spellcraft + melting dream-logic don't
  // belong on hard-surface robot renders.
  vibesByPath: {
    'cyborg-woman': [
      'cinematic',
      'dark',
