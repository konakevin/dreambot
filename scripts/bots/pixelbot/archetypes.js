...
module.exports = {
  ...
  description: 'PATH-BESPOKE — PixelBot jrpg-combat path (2026-05-20 axis-system migration). 16-BIT JRPG COMBAT GAMEPLAY SCREENSHOTS — Final Fantasy IV/V/VI / Chrono Trigger / Secret of Mana / Star Ocean / Tales of Phantasia / Lufia II. Top-down OR 3/4-iso camera. 5 mandatory elements (tile floor + party of 2-4 + monster + visible spell-effect + open-world setting). 3 path-bespoke pools + 40%-gated spell_effect.',
  slots: { universal: [], bot: [], path: [ 'open_world_setting', 'monster_enemy', 'party_engagement' ] },
  pickN: {},
  ...
  PIXELBOT_BOSS_ARENA: {
  description: 'PATH-BESPOKE — PixelBot boss-arena path (2026-05-20 axis-system migration). 16-BIT BOSS-BATTLE GAMEPLAY SCREENSHOTS — Chrono Trigger / FFVI / Secret of Mana / LttP / Diablo II / Hyper Light Drifter / Hades / Octopath. Camera flexibility (top-down OR 3/4-iso OR side-view per arena). 4 mandatory elements: arena floor + boss sprite + player sprite + arena walls. 3 path-bespoke pools + 40%-gated phenomenon.',
  slots: { universal: [], bot: [], path: [ 'arena_setting', 'boss_creature', 'player_engagement' ] },
  pickN: {},
  ...
  description: 'PATH-BESPOKE — PixelBot side-scroller-world path (2026-05-20 axis-system migration). 16-BIT SIDE-SCROLLING PLATFORMER GAMEPLAY SCREENSHOTS — Castlevania IV / Super Metroid / Donkey Kong Country / Mega Man X / Owlboy / Hollow Knight pixel / Dead Cells / Ori / Celeste. HORIZONTAL SIDE-VIEW camera, 5 mandatory elements (horizontal frame + foreground platform + player-sprite + middle parallax + far backdrop). 3 path-bespoke pools + 40%-gated atmospheric_phenomenon.',
  ...
  description: 'PATH-BESPOKE — PixelBot dungeon-depth path (2026-05-20 axis-system migration). 16-BIT TOP-DOWN DUNGEON-CRAWLER GAMEPLAY SCREENSHOTS — Diablo I/II / Hades / Hyper Light Drifter / Children of Morta / Moonlighter / Heroes of Hammerwatch. Top-down or 3/4-iso camera, hero adventurer pixel-sprite + monster encounter mid-action + Diablo-style loot/props + visible tile-floor. 3 path-bespoke pools + 40%-gated loot_detail.',
  ...
  PIXELBOT_EPIC_VISTA: {
  description: 'PATH-BESPOKE — PixelBot epic-vista (2026-05-20 axis-system migration). 16-BIT SIDE-SCROLLING PARALLAX-VISTA GAMEPLAY SCREENSHOTS — FF6 airship-flyover + Chrono Trigger world-map + Lufia II overworld + Secret of Mana world-vistas + Terranigma overworld + Castlevania IV background-vistas + Donkey Kong Country backgrounds + Sonic 2/3 horizons. SCENE-AS-HERO (no character), 4 parallax depth layers with HARD pixel-edges. Horizontal side-scrolling camera (reads left-to-right). 3 path-bespoke pools + 40%-gated parallax_silhouette.',
  slots: { universal: [], bot: [], path: [ 'vista_subject', 'sky_or_backdrop', 'lighting_atmosphere' ] },
  pickN: {},
