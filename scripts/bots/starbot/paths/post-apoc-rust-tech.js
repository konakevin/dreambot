 ...
 *
 * See:
 *   - scripts/lib/archetypes.js          (STARBOT_POST_APOC_RUST_TECH slots)
 *   - scripts/lib/archetype-templates.js (STARBOT_POST_APOC_RUST_TECH brief)
 *   - BOT_SCENE_QUALITY_PLAYBOOK.md      (vertigo-composition + bush-fix DNA reference)
 */

module.exports = {
  archetype: 'STARBOT_POST_APOC_RUST_TECH',
  pools: {
