...
module.exports = {
  ...
  BLOOMBOT_LANDSCAPE: {
  description: 'PATH-BESPOKE — BloomBot landscape path. NOT IN USE (2026-05-16 migration attempted + REVERTED; legacy compose.js outperforms). Archetype + template + pools preserved for reference / future re-attempt. See memory file project_bloombot_landscape_kept_legacy.md for the over-stuffed-brief diagnosis.',
  slots: { universal: [], bot: [], path: [ 'landform', 'scale_prover', 'surprise_element', 'sky' ] },
  pickN: {},
  ...
  description: 'PATH-BESPOKE — BloomBot garden-walk path (2026-05-16 migration). WALKABLE FLORAL PASSAGE inviting the viewer in. SYMMETRIC PORTRAIT composition mandate (archway centered, path leading dead-center, frame divided into foreground bloom-mass on each side + glowing depth-of-field at the path far end). 3 path-bespoke axes (archway_type / path_material / destination_glimpse) + 60%-gated atmospheric_phenomenon. Palette + lighting + roster via sharedDNA.',
  slots: { universal: [], bot: [], path: [ 'archway_type', 'path_material', 'destination_glimpse' ] },
  pickN: {},
  ...
  description: 'PATH-BESPOKE — BloomBot conservatory path (2026-05-16 migration). VICTORIAN GLASS-AND-IRON CONSERVATORY interior fully OVERGROWN. NON-NEGOTIABLE Victorian glass-dome + wrought-iron framework architecture. Half-architectural / half-jungle. Wide-angle interior shot with volumetric god-rays through the glass. 3 path-bespoke axes (conservatory_type / structural_anchor / atmospheric_phenomenon 60%-gated). Palette + lighting + roster via sharedDNA.',
  ...
  description: 'PATH-BESPOKE — BloomBot city-flowers path (2026-05-16 migration). URBAN ARCHITECTURE HALF-CONSUMED BY FLOWERS. Wide street-photography composition with pedestrian-level POV + leading-lines into city depth. Architecture is the STRUCTURAL HERO; blooms are DISTRIBUTED MASS across balconies / window-boxes / iron grilles / staircases. 3 path-bespoke axes (city_setting / architectural_detail / atmospheric_phenomenon 60%-gated).',
