...
const pathBuilders = {
  ...
  'creature-amusement-park': require('./paths/creature-amusement-park'),
  'creature-beach-day': require('./paths/creature-beach-day'),
  'creature-camping': require('./paths/creature-camping'),
  'creature-snow-day': require('./paths/creature-snow-day'),
  'creature-county-fair': require('./paths/creature-county-fair'),
  'creature-birthday-party': require('./paths/creature-birthday-party'),
...
module.exports = {
  ...
  modelByPath: {
    ...
    'creature-amusement-park': 'black-forest-labs/flux-1.1-pro-ultra',
    'creature-beach-day': 'black-forest-labs/flux-1.1-pro-ultra',
    'creature-camping': 'black-forest-labs/flux-1.1-pro-ultra',
  ...
  sensoryAnchors: {
    ...
    pathContext: {
      ...
      'creature-amusement-park': 'scene',
      'creature-beach-day': 'scene',
      'creature-camping': 'scene',
