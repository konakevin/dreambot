/**
 * CozyBot rainy-interior path — written 2026-05-05 in the CuddleBot
...
module.exports = ({ sharedDNA, vibeDirective, picker }) => {
  ...
  return `You are writing RAINY-INTERIOR scenes for CozyBot — beautiful interior SPACES on a stormy night, the viewer inside a warm private space with rain visibly streaming down a window. Snug bedroom with reading lamp + duvet, lo-fi desk by a window, café corner with rain on the glass, kitchen with a steaming kettle and rain-streaked window. The COZY ROOM + the WINDOW + the RAIN are the heroes — warm-amber inside contrasted against blue-grey storm outside. A small cute critter resident is ALWAYS present, peripheral. Pixar / Studio Ghibli / Beatrix-Potter / Howl's-Moving-Castle aesthetic. Output wraps with style prefix + suffix.
