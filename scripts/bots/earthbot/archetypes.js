...
module.exports = {
  EARTHBOT_EPIC_VISTA: {
    ...
    pickN: {},
    // 2026-06-30: gift-rate 0.65 (was 0.3) — most renders now carry a real optical/weather gift, paired with the earthbot_wow medium.
    conditionalLayer: { slot: 'phenomenon', gate: 0.65 },
    framingModes: null,
  ...
  EARTHBOT_FOREST_INTERIOR: {
    ...
    pickN: {},
    // 2026-06-30: gift-rate 0.65 (was 0.3) for the wow/lush rollout.
    conditionalLayer: { slot: 'phenomenon', gate: 0.65 },
    framingModes: null,
    anchorScaleRange: null,
  },
  ...
  EARTHBOT_REEF_PARADISE: {
    ...
    pickN: {},
    conditionalLayer: { slot: 'foreground_element', gate: 0.65 },
    framingModes: null,
    anchorScaleRange: null,
  },
  ...
  EARTHBOT_NIGHT_LANDSCAPES: {
    ...
    pickN: {},
    conditionalLayer: { slot: 'celestial_accent', gate: 0.65 },
    framingModes: null,
    anchorScaleRange: null,
  },
