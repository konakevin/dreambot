...
module.exports = {
  ...
  AFRICAN_SAVANNA_SUBJECT: load('african_savanna_subject'),
  AFRICAN_SAVANNA_FOREGROUND_ANCHOR: load('african_savanna_foreground_anchor'),
  AFRICAN_SAVANNA_LIGHT_CONDITION: load('african_savanna_light_condition'),
  AFRICAN_SAVANNA_ATMOSPHERE: load('african_savanna_atmosphere'),
  AFRICAN_SAVANNA_SKY_LAYER: load('african_savanna_sky_layer'),
  AFRICAN_SAVANNA_SCALE_PROVER: load('african_savanna_scale_prover'),
  AFRICAN_SAVANNA_PHENOMENON: load('african_savanna_phenomenon'),
