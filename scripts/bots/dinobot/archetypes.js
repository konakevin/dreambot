...
module.exports = {
  ...
  description: 'PATH-BESPOKE — DinoBot paleo-landscape path (2026-05-17 axis-system migration from legacy function-form). PURE PREHISTORIC LANDSCAPE — Mesozoic / Jurassic / Cretaceous IMAX-scale ancient world vistas. NO dinosaurs as primary subject (only tiny distant silhouettes via surprise_element). The PRIMORDIAL WORLD itself is the hero — mega-flora, alien Earth, lush, alive. Avatar Pandora × Skull Island × Land-of-the-Lost overgrown jungle cinematics. Reuses PREHISTORIC_SETTINGS (200) as biome. 5 path-bespoke axes (biome / megaflora / phenomenon 80%-gated / surprise_element / sky_layer) + universal lighting + atmosphere.',
  slots: {
  ...
  DINOBOT_SWAMP_RIVER: {
  description: 'PATH-BESPOKE — DinoBot swamp-river path (2026-05-17 axis-system migration from legacy function-form). MESOZOIC SWAMP / RIVER / WATERWAY with a SEMI-AQUATIC DINOSAUR interacting with the water. Spinosaur fishing / sauropod wading / hadrosaur drinking / mosasaur breaching / crocodilian floating / pterosaur skimming. Water is the setting; dino is the candid focal subject (25-40% frame). NO humans. National-Geographic-cinematic candid moment. 3 path-bespoke axes (water_scene / dino / surprise) + 80%-gated phenomenon + universal lighting + atmosphere.',
  slots: { universal: [ 'lighting', 'atmosphere' ], bot: [], path: [ 'water_scene', 'dino', 'surprise' ] },
  pickN: {},
  conditionalLayer: { slot: 'phenomenon', gate: 0.8 },
  framingModes: null,
  anchorScaleRange: null
  ...
  description: 'PATH-BESPOKE — DinoBot ocean-reptiles path (2026-05-17 axis-system migration from legacy function-form). STRICT MESOZOIC OPEN OCEAN with a MARINE REPTILE (mosasaur / plesiosaur / ichthyosaur / pliosaur / marine crocodile / Archelon sea-turtle / ammonite / marine pterosaur over ocean). Underwater scenes + mid-ocean breach + surface-break encouraged. NEVER river / swamp / lake. ONLY actual ocean dinosaurs (NO land dinos). 25-40% marine reptile + 55-65% ocean-scene (open water / underwater / breach / abyss / reef). 3 path-bespoke axes (ocean_scene / creature / surprise) + 80%-gated phenomenon + universal lighting + atmosphere.',
  slots: { universal: [ 'lighting', 'atmosphere' ], bot: [], path: [ 'ocean_scene', 'creature', 'surprise' ] },
  pickN: {},
  conditionalLayer: { slot: 'phenomenon', gate: 0.8 },
  framingModes: null,
  anchorScaleRange: null
  ...
  description: 'PATH-BESPOKE — DinoBot extinction-event path (2026-05-17 axis-system migration). K-Pg APOCALYPTIC scenes — asteroid streak across sky / impact-aftermath firestorms / impact-winter darkness / last-dinosaurs-in-dying-world. Epic tragedy + beautiful devastation. The end of the Mesozoic era. Reuses DINO_SPECIES (200) + EXTINCTION_SCENES (200 fat-seed) + DINOBOT_PALEO_LANDSCAPE_BIOME (200). Adds new path-bespoke pool for extinction-specific accents (ash-fall, ember-streams, distant-impact-glow, etc.). 4 path-bespoke axes (biome / species / extinction_scene / surprise_element) + 80%-gated phenomenon + universal lighting + atmosphere.',
  slots: {
    universal: [ 'lighting', 'atmosphere' ],
    bot: [],
