...
🚫 ONE small surprise per entry. Brand-free. NO scenes, NO surfaces — just the one toy/whimsy.`,
  ...
  // ═══════════════════════════════════════════════════════════
  // TOY-BLOCKBUSTER path (2026-05-25) — movie-poster epic scenes in ONE rolled
  // toy universe. These axes are UNIVERSE-AGNOSTIC (the medium supplies the toy
  // line) — NEVER name a toy material here, so any toy line can land in any scene.
  // ═══════════════════════════════════════════════════════════

  blockbuster_scenario: {
    format: 'simple',
    theme: `EPIC MOVIE-SCENE descriptors for toy-blockbuster — the climactic action beat. Each entry is ONE cinematic epic scenario (10-22 words) implying a CAST mid-action + an epic threat/stakes. UNIVERSE-AGNOSTIC — do NOT name any toy type/material (the medium supplies that); describe the ACTION + STAKES only, so any toy line (heroic or cute) can be dropped in.

✓ VARIETY — desperate last stand against an advancing horde, all-out fortress siege, climactic boss showdown, daring rescue under fire, high-speed chase, prison/cage breakout, charge across open ground, monster erupting from below, aerial dogfight, naval/water battle, arena tournament final, surprise ambush in the streets, evacuation as everything collapses, defending a bridge/gate, treasure grab under fire, ritual/portal interrupted, retreat-and-rally, duel at the climax, storming the throne, holding the wall.

🚫 NO toy materials/lines, NO specific characters, NO surfaces. ACTION + STAKES only. Always mid-action, never calm.`,
    touchpoints: [
      'a desperate last stand as a tiny band braces shoulder-to-shoulder against an advancing horde',
      'an all-out siege on a towering fortress gate, ladders going up under a hail of fire',
      'the climactic showdown — the hero squares off alone against the looming final boss',
      'a daring mid-battle rescue, one figure hauling a fallen ally clear as explosions bloom',
      'a breakneck chase through the streets, pursuers closing as the lead figure vaults a toppling barricade',
      'a monstrous threat erupting from below, the ground splitting as the cast scatters and rallies',
      'a charge across open ground into enemy lines, banners up, dust kicked into the air',
      'an arena tournament final, two champions clashing as a crowd of figures roars around the pit',
      'an evacuation as the world collapses behind them, the cast sprinting for the last way out',
      'a defiant stand defending a narrow bridge against an overwhelming force',
      'a heist escape gone loud, the crew fleeing across rooftops with the prize as alarms blare',
      'a final ritual interrupted — the heroes burst in as a glowing portal tears open',
    ],
    instructions: `Each entry 10-22 words. ONE universe-agnostic epic action scenario (cast mid-action + stakes). NO toy materials, NO characters, NO surfaces. Always mid-action. Output as a NUMBERED list (1. ... 2. ...), one entry per line. NO internal newlines.`,
  },

  blockbuster_centerpiece: {
    format: 'simple',
    theme: `BIG-STATEMENT CENTERPIECE descriptors for toy-blockbuster — the ONE massive focal element that dominates the movie-poster frame and dwarfs the cast. Each entry (10-20 words) is a colossal threat / set-piece. UNIVERSE-AGNOSTIC — describe the SHAPE/SCALE/MENACE only, NOT the toy material (the medium renders it in-universe, e.g. a giant Funko boss, a colossal claymation monster, a huge plush kaiju).

✓ VARIETY — a towering hulking boss-monster, a colossal war-machine / mech bristling with guns, a giant kaiju rising over the cast, a massive ancient stone idol cracking open, an enormous crashed warship hull, a gigantic many-legged beast, a towering armored warlord/commander, a colossal tank rolling forward, a huge serpent/dragon coiling overhead, a monstrous tentacled horror, a giant flaming portal/rift, a vast fortress-wall looming, a colossal robot fist smashing down, a huge horned demon-king.

🚫 NO toy materials/lines named. Render it MASSIVE + menacing — the poster "wow".`,
    touchpoints: [
      'a towering hulking boss-monster looming over the cast, fists raised, filling the upper frame',
      'a colossal war-machine bristling with cannons, grinding forward and dwarfing everything below',
      'a giant kaiju rising over the skyline, jaws wide, roaring down at the tiny defenders',
      'a massive ancient idol cracking open, light blasting from the seams as it awakens',
      'an enormous crashed warship hull jutting up at an angle, the cast tiny against its flank',
      'a towering armored warlord raising a huge blade above the outmatched heroes',
      'a colossal serpentine dragon coiling overhead, smoke pouring from its nostrils',
      'a giant flaming rift tearing open the sky, silhouettes pouring through it',
      'a monstrous many-tentacled horror heaving up out of the dark, limbs everywhere',
      'a vast fortress wall and gate looming over the assault, defenders dotted along the top',
      'a colossal robot fist mid-smash crashing down toward the scattering cast',
      'a giant horned demon-king wreathed in fire, throne-shadow falling across the field',
    ],
    instructions: `Each entry 10-20 words. ONE colossal universe-agnostic centerpiece (shape/scale/menace only). NO toy materials. Render MASSIVE + dominating. Output as a NUMBERED list (1. ... 2. ...), one entry per line. NO internal newlines.`,
  },

  blockbuster_setting: {
    format: 'simple',
    theme: `EPIC-STAGE SETTING descriptors for toy-blockbuster — a REAL-WORLD surface/place transformed by set-decoration + forced perspective into an epic location at TOY SCALE. Each entry (14-28 words) names the real surface AND how it reads as an epic stage, with set-dressing.

✓ MAXIMIZE LOCATION-TYPE VARIETY — every entry must read as a DISTINCT kind of place. Spread widely across: dense city streets (cereal-box skyscrapers), stormy invasion beach, raging bathtub sea, lush jungle warzone (houseplant canopy), interior command bunker / war-room, grand throne-hall or temple interior, colosseum / arena pit, rooftop skyline at night, a long bridge or gate-causeway, snow-blasted arctic front (flour drifts), volcanic ember-field, neon street-market, a flooded sink-ruin with waterfalls, a launchpad / hangar, a sewer-tunnel, a swamp, a desert dune-front, a carnival / fairground, a train-yard, a dockside harbor.

🚫 HARD ANTI-DEFAULT — do NOT lean on rocky canyons, ravines, gorges, cliff-ranges, mountain passes, or generic rock-walled corridors. Those are massively overused — at most 1 in 12 entries. Favor cities, water, interiors, jungle, snow, rooftops, arenas, harbors instead.
🚫 Always a REAL surface dressed up at toy scale (practical props). NO toy materials/lines, NO characters. Real-world-as-epic-stage.`,
    touchpoints: [
      'a kitchen counter staged as a war-torn city — cereal-box skyscrapers, spilled-sugar snow drifts, a toppled mug like a fallen tower',
      'a storm-lashed beach as an invasion shore, wet sand churned, driftwood barricades, real surf crashing in the background',
      'a bathtub as a raging sea, bubble-foam whitecaps and a washcloth raft pitching on the swell',
      'a backyard garden bed as a lush jungle warzone, towering clay-pot ziggurats, fern-frond canopy overhead, mulch craters',
      'a cluttered desk as a fortified command bunker interior — pencil girders, stacked-book ramparts, a mug watchtower, paper-map table',
      'a bookshelf row dressed as a grand temple-hall interior, leather spines as pillars, a ribbon banner strung overhead',
      'a dinner plate as a colosseum arena pit, ringed by salt-shaker columns, crowd-figures dotting the rim',
      'a windowsill as a neon rooftop skyline at night, potted-plant towers, the real city lights glittering beyond the glass',
      'a piano-key causeway as a long contested bridge, black keys as gun-ramparts, a drop into shadow on either side',
      'a flour-dusted countertop as a snow-blasted arctic front, drifts banked against a toppled cup-bunker',
      'a fireplace hearth as a volcanic ember-field, glow from real coals, ash drifts and blackened log-ridges',
      'a kitchen sink as flooded ruins, dripping faucet-waterfall, sponge-island, a soap-dish lifeboat adrift',
    ],
    instructions: `Each entry 14-28 words. ONE real-world surface dressed by set-decoration into an epic stage at TOY SCALE. MAXIMIZE distinct location TYPES (cities, water, interiors, jungle, snow, arenas, rooftops, harbors). Do NOT default to rocky canyons/ravines/cliffs. NO toy materials, NO characters. Output as a NUMBERED list (1. ... 2. ...), one entry per line. NO internal newlines.`,
  },

  blockbuster_camera: {
    format: 'simple',
    theme: `CINEMATIC MOVIE-POSTER CAMERA / FRAMING for toy-blockbuster. Each entry (12-26 words) is ONE dramatic blockbuster framing that shows the ensemble AND the giant centerpiece, with forced-perspective scale contrast.

✓ MANDATORY — cinematic + epic, forced-perspective scale contrast (cast small + heroic against the huge centerpiece), the whole ensemble + centerpiece readable in frame.
✓ VARIETY — low hero up-angle gazing up at the looming centerpiece, sweeping wide aerial establishing, anamorphic ultra-wide, dramatic dutch-tilt mid-action, over-the-shoulder behind the hero facing the threat, silhouetted hero against an explosion/light-burst, low tracking shot through the charge, three-quarter wide ensemble hero-shot.

🚫 NO macro single-figure close-up that loses the ensemble/centerpiece, NO flat snapshot. Always cinematic + scale-proving.`,
    touchpoints: [
      'low hero up-angle gazing up past the cast at the looming centerpiece filling the sky, epic and dwarfing',
      'sweeping wide aerial establishing shot, the whole battlefield + the giant threat readable, cast like ants below',
      'anamorphic ultra-wide poster frame, ensemble fanned across the foreground, centerpiece towering at center',
      'a dramatic dutch-tilt mid-action, debris and fire streaking across the canted frame',
      'over-the-shoulder behind the lone hero facing the colossal threat across the battlefield',
      'a silhouetted hero in dynamic pose against a blinding explosion / light-burst, centerpiece behind',
      'a low tracking shot rushing through the charging cast toward the giant centerpiece ahead',
      'a three-quarter wide ensemble hero-shot, the squad mid-stride with the towering threat behind them',
    ],
