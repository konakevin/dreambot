...
3. A circle of slender high-elves in flowing moonlit robes gathered in a glade, graceful and still, their pale faces lit by drifting magical light.`,
  ...
  fae_setting: {
    format: 'simple',
    theme: `DRAGONBOT FAE-COURT SETTING — the enchanted natural setting. Each entry 25-45 words, with depth + magic.
...
3. A grove of crystal trees that chime softly, refracting moonlight into drifting rainbows across the glade, a still reflecting pool at its heart.`,
  ...
  fae_detail: {
    format: 'simple',
    theme: `DRAGONBOT FAE-COURT DETAIL — the delicate magic in the air (the enchantment). Each entry 12-25 words.
...
3. Petals fall in slow spirals through shafts of moonlight, each one catching a soft silver glow.`,
  ...
  fae_surprise: {
    format: 'simple',
    theme: `DRAGONBOT FAE-COURT SURPRISE — a small enchanting touch rewarding a closer look, fires always. Each entry 12-25 words.
...
3. A white stag stands motionless among the distant trees, antlers catching the moonlight.`,
  ...
  fae_drama: {
    format: 'simple',
    theme: `DRAGONBOT FAE-COURT DRAMA — a secondary focal point heightening the magic, fires ~40%. Each entry 12-25 words.
