...
const POOL_RECIPES = {
  ...
  landscape_architecture: {
    format: 'simple',
    theme: `ARCHITECTURAL ELEMENTS that anchor composition in a fantasy landscape. The architecture is NOT the hero — it's the COMPOSITION ANCHOR placed at midground or deep distance, drawing the eye to a focal point within the larger biome. Each entry 20-40 words. Format: "[ARCHITECTURE TYPE] — [signature visual feature + scale + condition]".\n\nSTRICT Western high fantasy — LOTR / GoT / Skyrim / Witcher / Warcraft / D&D / Elden Ring tradition. NO real-world ethnic codes.\n\nVARIETY: castles (intact / ruined / partial) / towers (lone / multi-tower / spire) / monasteries / temples / bridges (stone / rope-and-plank) / colonnades / arches / standing-stones / ancient-runic-pillars / dwarven-stone-gates / elven-treehouses / pagodas-without-Eastern-coding... actually skip pagodas. Use: lighthouse / gatehouse / wizard-tower / mage-academy / dragon-roost / sky-spire / floating-island / shrine / way-cairn / megalithic-arch.`,
    touchpoints: [
  ...
  landscape_sky: {
    format: 'simple',
    theme: `SKY / OVERHEAD ELEMENTS for a fantasy landscape — the dramatic atmospheric layer that occupies the upper half of the frame. Each entry 15-30 words. Format: "[SKY DESCRIPTION] — [signature feature + light/color/atmospheric quality]".\n\nVARIETY: dawn / golden hour / high noon with cumulus / blue hour / dusk / starlit night / moonlit night / cloudy overcast / storm-cloud / aurora / twin moons / triple moons / unreal-color sky (lavender / mint-green / amber-violet) / arcane-aurora-storm / nebula-visible-in-day / sky with floating islands / sky with comet / sky with passing flying beast / sky with rainbow / sky with sun-pillar / sky with halo-around-sun / sky with thin-cirrus-streaks / sky with mammatus / sky with crepuscular-rays / sky with sundogs.`,
    touchpoints: [
