...
const POOL_RECIPES = {
  ...
  // lives here, locked.
  artsy_girl_outfit: {
    theme: 'BATTLE-READY FORM-FITTING fantasy COMBAT armor for a heroic female adventurer. Frank Frazetta / Boris Vallejo / Brom / Hildebrandt / Michael Whelan painted-fantasy-novel-cover tradition. Time-period LOTR / D&D / GoT / Witcher / Skyrim medieval-fantasy. Every outfit is OBVIOUSLY for COMBAT and ADVENTURING — chainmail / plate / leather armor / engraved metalwork / functional weapon-harness — NOT pretty dress, NOT peasant cloth, NOT boho fabric. Sleek FORM-FITTING silhouette that accentuates body shape but is CLEARLY combat-built. Each entry 30-60 words.\n\nABSOLUTE BANS — every entry MUST avoid these tokens:\n• NO FUR / NO FUR-TRIM / NO FUR-LINED — pure ban, never any fur references\n• NO long flowing dresses, NO peasant cloth, NO ren-faire smocks\n• NO boho-fantasy gauze, NO silk skirts, NO soft fabric primary\n• NO heavy boxy plate that hides body shape (sleek form-fitting only)\n• NO modern outdoor gear / NO hiking-coded gear\n• NO bare-arm tank-top, NO bikini-armor cheesecake\n\nMANDATORY in every entry:\n• Visible HARD ARMOR — chainmail OR engraved plate OR hardened leather OR dragonscale OR chitin OR elven mail\n• Visible WEAPON or COMBAT GEAR — sword/dagger sheath, bow + quiver, axe, mace, war-staff, twin blades — strapped to her, ALWAYS combat-ready\n• Functional armor pieces — pauldrons, bracers, greaves, gorget, vambraces — at least 2 named pieces per outfit\n• Form-fitting silhouette explicitly stated',
    touchpoints: [
      'Eowyn LOTR battle armor — chainmail under engraved breastplate, fitted vambraces, sword strapped at hip, royal-emblem tabard',
      'Ciri Witcher leather — fitted dark hardened-leather cuirass + tactical buckles, twin sword harness across back, fingerless gloves',
      'Daenerys late-GoT — ornate dragonscale-leather riding cuirass, blade at hip, no soft fabric anywhere',
      'Skyrim Nightingale rogue armor — fitted black-leather cuirass + hood + tactical wraps, daggers on hip-belt',
      'Skyrim Daedric battle armor (form-fit female variant) — black engraved plate spikes, scimitar at back',
      'D&D paladin — fitted silver-and-gold engraved breastplate over chainmail, longsword across back, tabard',
      'D&D ranger — fitted hardened-leather cuirass + cloak + bow-quiver harness, hand-axe on belt',
      'D&D rogue — fitted black-leather harness with buckles + dagger sheaths + hood, twin daggers',
      'Drow chitin armor — fitted black-purple chitin plates over close-fit bodysuit, hand-crossbow on hip, twin scimitars on back',
      'Tiefling demon-hunter — fitted dark-leather cuirass with embossed infernal-script, hand-crossbow on hip, twin sabers on back',
      'Galadriel-coded ceremonial battle-mail — silver-elven mail + glowing-rune bracers, tall sword',
      'Lothlórien elven mail — fitted luminous silver linkmail + grey-green tactical cloak, recurve bow + arrow-quiver',
      'Blood-elf paladin — fitted ornate red-and-gold engraved plate + glowing rune-bracers, two-handed hammer',
      'Witch-hunter long coat — fitted black leather coat-armor + bracers + pistol-bandolier + wide-brim hat, silver-tipped rapier',
      'Dragonscale plate — fitted dragonscale cuirass + segmented pauldrons + matching greaves, dragon-tooth dagger',
    ],
    instructions: `Each entry is ONE fantasy BATTLE outfit, 30-60 words. Format: "[archetype/type] — fitted/form-fit [armor body] + [named pieces: pauldrons/bracers/greaves/gorget] + [signature weapon/combat-gear visible]". MANDATORY: hard armor + weapon + functional pieces named + form-fitting silhouette explicit. ABSOLUTELY NO FUR. NO long flowing dress. NO peasant cloth. NO bare-arm cheesecake. Variety: rogue/ranger/thief (light leather + daggers) / paladin/warrior (plate + sword) / drow/tiefling/dragonborn racial battle armor / sorceress-warrior (engraved mail + staff). Every entry: dragon-killing adventurer, BEAUTIFUL DANGEROUS DEADLY combat-ready. Output JSON array of strings.`,
  },
  artsy_girl_action: {
    theme: 'Peaceful adventuring / candid / lineage-flavored moments for a female fantasy warrior — caught between battles, never in one. NO combat, NO mid-strike, NO weapon-aimed-at-foe. Hiking, traveling, in a tavern, breaking camp, scouting, polishing a sword, sharpening a blade, looking out from a cliff, eating by a campfire, sitting in a hostel, drawing a map, talking to a horse, drinking from a stream, examining a relic, fastening armor, lacing boots, etc. Each entry 20-40 words. CINEMATIC mid-moment, body in motion or candid stillness — never staged posing.',
    touchpoints: [
