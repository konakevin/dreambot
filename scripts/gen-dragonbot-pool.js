...
const POOL_RECIPES = {
  ...
  male_explorer_race: {
    format: 'simple',
    theme: `CAPABLE male fantasy adventurers — STRICT WESTERN HIGH FANTASY (LOTR / GoT / Elden Ring / Skyrim / Witcher / D&D). ONE race per entry, 18-35 words. Format: "[Race]: [build] + [skin/scale tone, FACE/IDENTITY only] + [eye detail] + [distinguishing features] + [facial-hair note]".\n\nDescribe the LINEAGE and FEATURES — let the render decide how old he is. Do NOT skew age; do NOT default to a "grizzled elder". "Capable / sure-handed / confident" is the bearing, NOT an age.\n\n⚠️ FACIAL-HAIR VARIETY: mix clean-shaven / light stubble / short trimmed beard / full beard / beardless-by-race. NOT all full-bearded.\n\nVARIETY across races: elves (Noldor / Sindar / Silvan / Drow — beardless), humans (Gondorian / Rohirrim / Nord / Dunedain / Cormyrean / Stormwind / desert-and-jungle fantasy heritages), dwarves (bearded), half-orcs (tusked), tieflings (horned), dragonborn (scaled, beardless), halflings, genasi, aasimar. Skin/scale tone is FACE/IDENTITY (NEVER torso). NO real-world ethnic costume codes.`,
    touchpoints: [
      'High Elf (Noldor): tall and lithe, pale luminous skin, storm-grey eyes, sharp fair features, clean-shaven, long platinum hair — composed and quietly lethal',
      'Gondorian human: athletic build, warm olive skin, steady hazel eyes, a thin scar through one brow, short trimmed dark beard — a capable ranger-knight',
      'Mountain Dwarf: stocky and barrel-chested, ruddy bronze skin, bright iron-blue eyes, a broad nose, full braided beard with a single clan-ring',
      'Half-Orc: broad and muscular with a heavy brow, grey-green skin, amber eyes, prominent lower tusks, close-cropped scalp and light stubble — watchful',
      'Wood Elf (Silvan): wiry ranger build, tan-copper skin, keen emerald eyes, faint freckling, beardless, dark hair in a half-tie — fox-quick',
      'Dragonborn (Bronze): tall reptilian frame, burnished bronze scales, molten-gold eyes, blunt snout and short horns, beardless — a calm, immovable presence',
      'Rohirric human: rangy horseman build, sun-warmed fair skin, pale-blue eyes, windburn high on the cheeks, blond stubble — easy in the saddle',
      'Tiefling (Mephistopheles): lean and tall, dusk-violet skin, gold slit-pupil eyes, swept-back ridged horns, clean-shaven sharp jaw — self-assured',
      'Drow (Dark Elf): slim and agile, obsidian-grey skin, pale lilac eyes, fine angular features, beardless, white hair cropped short — cool and precise',
      'Nord human: tall and broad-shouldered, fair weather-flushed skin, ice-grey eyes, a healed cheek-scar, short reddish-blond beard — hardy and good-humoured',
      'Dunedain human: lean ranger build, tan skin, deep grey eyes, a quiet steady gaze, dark hair and a few days of stubble — unhurried and sure',
      'Halfling (Stoutheart): compact and sturdy, ruddy tan skin, warm brown eyes, curly hair, neat sideburns and clean chin — cheerful and quick on his feet',
    ],
    instructions: `Each entry is ONE race, 18-35 words. CAPABLE bearing, NOT an age — let the render decide how old he is, do NOT skew toward grizzled elders. Vary facial hair (clean / stubble / short / full / beardless-by-race). Skin/scale tone is FACE/IDENTITY only, NEVER torso. NO real-world ethnic codes. NO TWO entries share race+facial-hair combo. Output as a NUMBERED list (1. ... 2. ... 3. ...), one entry per line.`,
  },
  male_explorer_class: {
    format: 'simple',
    theme: `Fantasy class IDENTITY + BEARING for a male adventurer — D&D × LOTR × Witcher × WoW × Elder Scrolls tradition. The class is his ROLE and ENERGY only — NOT his gear (gear lives on a separate axis). Each entry 15-30 words. Format: "[CLASS-CAP] — bearing + iconic energy + signature trait of how he carries himself".\n\n⚠️ BADASS / FOREBODING / DANGEROUS TONE — CRITICAL ⚠️\nThe male characters should feel BADASS, FOREBODING, MYSTERIOUS, DANGEROUS, EXPERIENCED, WEATHERED. NOT pretty/soft/quaint/serene. Every bearing descriptor should convey at least one of:\n  • HARD-WON / BATTLE-TESTED / WEATHERED-BY-A-HUNDRED-FIGHTS\n  • EYES THAT HAVE SEEN TOO MUCH / FLAT-COLD / HAUNTED / DISTANT\n  • PRESENCE THAT MAKES PEOPLE STEP ASIDE / DANGEROUS-EVEN-AT-REST\n  • SCARRED / WEATHERED / GRIZZLED / VETERAN\n  • MYSTERIOUS / SOMETHING-HIDDEN-BENEATH / NOT-TO-BE-CROSSED\n  • BLEAK / GRIM / TAUT-WITH-CONTROLLED-INTENT\n  • SOMETHING IS WRONG ABOUT HIM (in the warlock / necromancer / hexblade cases)\n\nReplace soft tropes with hard ones:\n  • NOT "moves with grace" → "moves with the economy of someone who's killed quietly before"\n  • NOT "carries serene authority" → "carries the dead-calm of someone whose voice is the last warning"\n  • NOT "stands with conviction" → "stands like a man who has buried his own brothers and kept walking"\n  • NOT "exudes charm" → "smiles like someone who knows where every blade in the room is"\n  • NOT "spine straight with noble obligation" → "spine straight from a lifetime of bearing weight others would not"\n\nABSOLUTE BANS:\n• NO specific weapons named (accessory axis)\n• NO specific outfit pieces named (outfit axis)\n• NO race-anatomy (race axis)\n• NO shirtless / bare-chested / cheesecake language\n• NO "smoldering" / "brooding heart-throb" romance-stock language — DANGEROUS not SEXY\n\nMANDATORY in every entry:\n• A CLASS NOUN\n• A BEARING DESCRIPTOR conveying the badass / dangerous tone\n• A SIGNATURE class-energy detail\n\n⚠️ ROSTER VARIETY IS CRITICAL — the pool MUST cover the full Western high-fantasy class roster. Distribute roughly:\n\n  **MARTIAL** (~30%): WARRIOR / KNIGHT / PALADIN / TEMPLAR / CRUSADER / CHAMPION / BARBARIAN / BERSERKER / KNIGHT-ERRANT / BLACKGUARD / WAR-PRIEST / CAVALIER\n  **STEALTH / SHADOW** (~15%): ROGUE / ASSASSIN / NIGHTBLADE / SHADOWMANCER / SHADOW PRIEST / HEXBLADE\n  **RANGED / WILDERNESS** (~15%): RANGER / HUNTER / WARDEN / SCOUT / BLADEDANCER / TRACKER\n  **ARCANE** (~20%): WIZARD / MAGE / SORCERER / ARCANIST / RUNECASTER / BATTLEMAGE / BLOODMAGE / ELEMENTALIST / CONJURER / SUMMONER\n  **OCCULT / DARK** (~10%): WARLOCK / NECROMANCER / HEXBLADE / DEATHKNIGHT / SOULBINDER / DEMONOLOGIST\n  **DIVINE / SPIRIT** (~10%): CLERIC / DRUID / MONK / SHAMAN / BARD / ORACLE / MYSTIC / SAGE / INQUISITOR / ARTIFICER\n\nThe pool must read as a FULL D&D-style party roster, not a robe-heavy mage subset. NO duplicate class entries — each class appears at most twice (with different bearing).\n\nWORLD CANON FLAVOR allowed: Witcher (school-of-wolf monster-hunter) / Skyrim (Companion / Nightingale / Imperial Legate) / WoW (Death Knight / Demon Hunter / Vindicator) / Elden Ring (Carian Knight / Sorcerer of the Academy) / D&D (Drow Blade-Singer / Dragonborn Champion) — as long as STRICTLY high fantasy.`,
  ...
  male_explorer_outfit: {
    format: 'simple',
    theme: `COOL GRITTY MASCULINE ARMOR for a male fantasy adventurer — STRICTLY HIGH-FANTASY (LOTR / GoT / Elden Ring / Skyrim / Witcher / Warcraft / D&D). Each entry 20-50 words. The target is BADASS WEATHERED FITTED ARMOR — the look that belongs on a Witcher / Elden Ring / Dragon Age cover. Battle-worn, road-grimed, rugged.\n\n✓ DOMINANT — ORNATE ARTICULATED ARMOR (~55%): fitted plate / breastplate-cuirass with pauldrons + vambraces + greaves + gorget; scale / lamellar / chitin-and-hide / brigandine / mail composite. Hand-forged, brass-riveted, runic-etched, blackened-steel, dented and weathered.\n✓ SECONDARY — BATTLE-LEATHER / RANGER (~30%): reinforced studded-leather cuirass / scout leathers / hide-and-mail over a covered under-layer, shoulder-harness with sheathed blades, tooled bracers.\n✓ MINORITY — MARTIAL CASTER (~15%): fitted battlemage coat-armor / runed-leather over a covered under-layer / arcane-plate — martial, NOT a flowing robe.\n\n🚫 MALE NSFW LINE (NEVER cross): every entry's CHEST is COVERED (name a cuirass / breastplate / gambeson / hauberk / brigandine / scale / coat). NEVER shirtless / bare-chested / exposed-torso / open-shirt-revealing-chest / oiled-pecs / loincloth / sleeveless-bare-arms-implying-bare-torso. NO skin-tight bodysuit. Paint/scars on FACE only.\n🚫 AVOID frumpy drapes (loose flowing robes / shapeless hooded coats / billowing). NO artist names (Frazetta / Brom / Vallejo / Boris / Hildebrandt / Whelan).\n\nVARIETY: differ per entry in armor archetype / material palette / fantasy-canon culture (Rohirrim / Gondorian / Dunedain / Nord / Witcher-school / Nilfgaardian / Quel'Thalas / Mahakaman dwarven / Drow / half-orc / etc.) / climate. Cloak/half-cape only as an accent over the armor.`,
    touchpoints: [
      'Weathered grey-steel articulated plate, dented across the breastplate, pauldrons + vambraces + greaves, a road-grimed dark cloak clasped at the gorget — Gondorian warden battle-worn warplate',
      'A Witcher-school cuirass of riveted blackened-steel plates over fitted dark leather, mismatched buckles, elbows re-hided, a wolf medallion at the throat — a decade of monster-hunting visible',
      'Heavy fur-trimmed scale armor over a thick gambeson, iron-banded pauldrons, a bearskin half-cloak off one shoulder, blond braided beard — a Nord shieldbrother winter warplate',
      'Reinforced oxblood studded-leather cuirass with a crossed-axe shoulder-harness, tooled vambraces, a hide half-cape — a wiry ranger built for the long road',
      'Mahakaman dwarven plate in verdigris-bronze, broad riveted chest-plate, engraved greaves, heavily-braided iron-ringed beard — squat, immovable, battle-scarred',
      'A Dunedain ranger mail hauberk under a weathered dark surcoat and travel-cloak, leather bracers, road-dust on every seam — understated and lethal',
      'Blackened Drow chitin-and-leather cuirass to the hip, matte glare-suppressed plates, a hooded dark coat over it, twin sheaths on the back-harness — Underdark scout',
      'A Nilfgaardian officer lacquered black breastplate with sun-sigil enamel, articulated lame skirt, vambraces, a long half-cape clipped at one shoulder',
      'A battlemage oxblood coat-armor plated with runed steel panels at the chest and shoulders, sigil-etched vambraces, a covered under-layer — martial, not a robe',
      'Fitted brigandine of riveted plates under dark canvas, a gambeson collar, mud-spattered greaves and a slung shield — a mercenary practical kit',
      'A Quelthalas blood-knight half-plate in red-and-gold, sculpted breastplate, layered pauldrons, a tabard over mail — burnished but battle-marked',
      'A half-orc raider lashed iron-and-hide chest-plate over fitted leather, bone-and-iron shoulder guards, tusked and scarred, a fur mantle at the collar',
    ],
    instructions: `Each entry is ONE cool gritty masculine ARMOR outfit, 20-50 words. TARGET: ~55% ornate articulated armor / ~30% battle-leather / ~15% martial-caster. Weathered, fitted, Witcher/Elden/Dragon-Age caliber. CHEST ALWAYS COVERED — name a chest-covering item every entry. NEVER shirtless / bare-chest / exposed-torso / oiled / skin-tight. AVOID frumpy drapes. NO artist names. NO TWO entries share archetype/material/culture. Output as a NUMBERED list (1. ... 2. ... 3. ...), one entry per line.`,
  },
