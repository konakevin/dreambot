...
3. A flock of glowing paper-birds takes wing through the warm candlelight, circling lazily up toward the carved elven galleries.`,
  ...
  arclib_set_pieces: {
    format: 'simple',
    theme: `DRAGONBOT ARCANE-LIBRARY SET-PIECES — the ENCHANTED TREASURES, MAGIC ITEMS, DRACONIC RELICS & whimsical curios woven into the COZY LIVED-IN clutter of the warm hall, the homey set-dressing that gives this ancient elven library its WONDER and soul (pickN:2 — two of these are scattered into every render). Each entry 12-25 words. SMALL objects tucked among the everyday clutter — NOT the focus, NOT a grand focal wonder, NOT the active drifting glowing tomes.

⚠ THE #1 RULE — COZY & LIVED-IN, NOT A MUSEUM. This is a beloved, much-used HOME library, not a treasury or gallery. Magic items and relics look USED and loved and casually part of daily life — nestled, tucked, leaning, piled, half-buried in books, warming by the hearth, used as everyday objects. ABSOLUTELY NO formal display framing: NO pedestals, NO glass domes / glass cases / vitrines, NO "displayed on a stand", NO velvet-lined display cushions, NO stasis-shimmer / floating-in-a-field displays, NO reliquary-on-a-plinth, NO roped-off museum/treasury/gallery vibe. Everything sits casually among the cushions, books, teacups and candle-stubs like it's always been there.

THE VIBE — a snug, cluttered, centuries-old elven scholar's home that happens to be full of dragon-lore wonders. This is DRAGONBOT — lean into DRACONIC + MAGICAL warmth. Cozy, curious, enchanting, and utterly lived-in.

VARIETY MANDATE — span ~25 distinct curio-clusters across these registers (TILT MAGICAL — roughly 60% enchanted/relic, 40% mundane), ALL framed cozy + lived-in:
  ENCHANTED / MAGIC ITEMS & DRAGON EGGS (~half): a clutch of jewel-toned DRAGON EGGS nestled in a blanket-lined basket warming by the hearth; a single cracked dragon egg cradled in a nest of cushions on a reading-chair, faint amber light pulsing within; a glowing scrying-orb resting in a wooden bowl among loose papers; a rack of stoppered potion-bottles crowded on a cozy shelf between teacups and herb-jars; an old rune-etched gauntlet and amulet hung casually on a hearthside coat-hook; an hourglass of glowing star-sand on a cluttered desk among ink-stains and crumbs; a horned DRAGON SKULL on the corner of a book-piled desk, a candle-stub burning in one eye-socket, mugs and quills tucked around it; a terrarium of glowing fey-mushrooms on a windowsill beside potted ferns; a worn talisman looped over a chair-back; a little captured flame flickering in a stoppered jar by the teapot.
  DRACONIC RELICS / OLD RELICS (~few): an old relic-blade leaning casually in a book-piled corner, its runes faintly aglow; iridescent dragon scales used as bookmarks and paperweights across an open tome; a dented ancient crown holding down a stack of loose maps; a cracked dragon-rune tablet propped behind a row of jam-jars and candle-stubs; a fossilized dragon tooth holding a shelf of leaning books upright.
  MUNDANE LIVED-IN CURIOS (~40%): a brass astrolabe and half-melted candle-stubs on a cluttered desk; dried herbs and star-charts hung from the beams; ferns in glazed pots on a sill; a model elven ship in a dusty bottle; quills in a stone inkpot; a rolling brass-railed ladder; a globe and a magnifying lens; stacked cushions and a forgotten teacup; a carved chess set mid-game.
Each entry is ONE small cluster in one spot, leading with its hero object, framed casually + cozily.

LIGHT — HIGH FANTASY, NO ELECTRICITY: any light named is candle/taper/candelabra/brazier/hearth/daylight/soft MAGICAL glow ONLY (glowing relics, fey-light, luminous orbs). ABSOLUTELY NO modern "lamps", NO lanterns that look electric, NO lightbulbs, NO glass desk-lamps.

ALSO — these are COZY SET-DRESSING tucked among the clutter. Do NOT describe the architecture, the single hero focal wonder (hearth/orrery/window — a different axis), or the drifting glowing tomes/runes (a different axis). Mostly OBJECTS — a live critter (dozing cat) only RARELY, never the point; dragon eggs/skulls/relics are OBJECTS and very welcome.`,
    touchpoints: [],
    instructions: `Each entry is ONE small cluster of enchanted treasures, magic items, dragon eggs, draconic relics, or whimsical curios tucked into the COZY LIVED-IN clutter in 12-25 words — homey + warm + used, NEVER a formal museum/pedestal/glass-case display, period-correct (NEVER a modern lamp/lantern/electric light). TILT MAGICAL (~60% enchanted/relic, 40% mundane). Mostly objects; a live critter only rarely. Output a NUMBERED list.

EXAMPLES (3):
1. A clutch of jewel-toned dragon eggs nestles in a blanket-lined basket warming by the hearth, one shell faintly aglow among the rumpled wool.
2. A horned dragon skull rests on the corner of a book-piled desk, a candle-stub burning low in one eye-socket, mugs and quills tucked around it.
3. A brass astrolabe and a scatter of half-melted candle-stubs crowd a cluttered desk, an inkpot bristling with quills beside a rolled, dog-eared map.`,
  },
...
CASTER CLASS VARIETY — distribute roughly equal:
  ...
  male_action_scenes_action: {
    ...
    touchpoints: [
      ...
      'MONK CHI-STRIKE — dropping into a deep grounded lunge, back leg driving a low kick with chi-glow trailing his extended leg in a brilliant luminous arc, weight planted on his front foot, robe rippling violently and cherry-petals blasted outward from the impact-zone, a temple gong cracking from the impact behind him',
      ...
      'PIVOT BACK-SHOT — in a low braced crouch against a stone wall, twisting at the waist to release an arrow back over his shoulder at a pursuer, motion-blur trail across his bow-arm and lantern-glow lighting him from below, a lantern-lit alley in chaos with two armed pursuers entering',
      ...
      'ROOFTOP DROP — at the apex of a grounded leap off a steep clay rooftop, feet beneath him and clearly falling toward a guard below, dagger reversed in his hand, his cloak streaming up from the fall, a moonlit citadel courtyard with two more guards reacting to his arrival, a distant fire on the next rooftop',
      ...
      'BATTLEMENT-SPRINT ESCAPE — at a hard ground sprint along the top of a battlement, behind him a fireball-strike erupting against the stone with debris exploding outward, foreground crenellation sparks, a moat far below with crocodiles, archers on the far tower reloading',
  ...
  female_action_scenes_action: {
    ...
    touchpoints: [
      ...
      'PIVOT BACK-SHOT — in a low braced crouch against a stone wall, twisting at the waist to release an arrow back over her shoulder at a pursuer, [environmental:] motion-blur trail across her bow-arm and lantern-glow lighting her from below, [context:] a lantern-lit alley in chaos with two armed pursuers entering the foreground and shop-windows reflecting torch-fire',
      ...
      'ROOFTOP DROP — at the apex of a grounded leap off a steep clay rooftop, feet beneath her and clearly falling toward a guard below, knife reversed in her hand, [environmental:] her hair streaming up from the fall, [context:] a moonlit citadel courtyard with two more guards reacting to her arrival, a distant fire on the next rooftop, torch-bearers crossing the courtyard unaware',
  ...
  female_adventurer_action: {
    ...
    touchpoints: [
      ...
      'AT THE SHAFT RIM — crouched at the edge of the descent, the anchored rope gripped in one fist, boot planted on the slick stone lip, lantern raised to study the darkness she is about to enter',
...
⚠️ ORIGINAL HEADER NOTES PRESERVED (sleek adventuring gear, Painterly fantasy concept-art tradition WITHOUT artist callouts, 20-50 words per entry).\n\n🚫 **ABSOLUTE BAN — NO real-world ethnic costume codes.** This is Western HIGH FANTASY, not historical cosplay. Specifically forbidden:\n  • NO Bedouin / Arabic / Middle-Eastern-coded\n  • NO Persian / Ottoman-coded\n  • NO Mongol / Steppe-nomad-coded\n  • NO Aztec / Mayan / Andean / Inca-coded\n  • NO Polynesian / Pacific-Islander-coded\n  • NO Indian / Indian-subcontinent / sari-coded\n  • NO Samurai / Japanese / hakama / kimono-coded (NO Eastern)\n  • NO Egyptian / Roman / Greek / Byzantine-coded\n  • NO Norse Viking (the racial template "Nord" is fine; "Norse-coded barbarian" is fine; but don't drift into real-world Viking historical-costume reference)\n\nThe high fantasy world has its OWN climate-and-culture variety vocabulary — use IT:\n\n⚠️ CLIMATE DISTRIBUTION IS CRITICAL — DO NOT default to "leather coat over wool inner over trousers and boots with hood". Target distribution:\n\n  A. **WARM-CLIMATE / LIGHT** (~35% of pool — use HIGH FANTASY analogues):\n    • Dornish (GoT) / Hammerfell-Redguard (Skyrim) / Haradrim (LOTR) / Khanduras (Diablo) / South Reach\n    • Chult (FR) / Stranglethorn (WoW) / Sothoryos (GoT) jungle outfits\n    • Anauroch (FR) / Athasian (Dark Sun) desert-fantasy explorers\n    • Light fitted single-layer tunic + breeches\n    • Sleeveless gambeson with bracered forearms\n    • Sun-cloak + light leathers\n    • Lightweight scale over a thin under-layer\n    • Sorceress in a fitted travel-robe, NOT bundled\n  B. **TEMPERATE / MID** (~35% of pool):\n    • Rohirrim / Gondorian / Dúnedain / Cyrodiil-Imperial / Witcher-school / Eriador-ranger / Bretons-Highgarden\n    • Fitted ranger leathers / hooded scout coat that ends at the hip\n    • Civilian bardic doublet\n    • Paladin half-plate over surcoat\n    • Mage's traveling robes (not full winter cloak)\n    • Cuirass over thin gambeson\n  C. **COLD-CLIMATE / LAYERED** (~30% of pool, NOT MORE):\n    • Skyrim Nords / Witcher's Northern Realms / Forodwaith / The North (GoT) / Stormcloak\n    • Bearskin / hide-and-fur / arctic shaman / Eriador winter-cloak\n    • These belong but DO NOT dominate.\n\n⚠️ SILHOUETTE VARIETY IS CRITICAL — DO NOT default to "long coat over trouser-and-boot". Distribute across:\n\n  A. ROBES / DRESSES-AS-ARMOR — mage cassock / cleric vestments / monk wrap (Western monastic, not Eastern) / sorceress flowing travel-robe / druidic moss-robe — flowing, NOT coat-over-trouser\n  B. CUIRASS / BREASTPLATE FOCUS — steel breastplate + skirt-of-chain-and-leather / scale cuirass over fitted under-coat — the armor is THE statement\n  C. SINGLE-LAYER FITTED — light tunic + breeches with NO coat / sleeveless gambeson / fitted linen riding outfit\n  D. HOODED COAT — the historic bias, legitimate but ONE option, not default\n  E. PLATE / HEAVY ARMOR — full half-plate / engraved cuirass + greaves\n\nSTRUCTURAL VARIETY in entry shape (mix all):\n  A. SILHOUETTE-LED — leads with the shape\n  B. MATERIAL-LED — leads with the dominant fabric/metal\n  C. SINGLE-PIECE FOCUS — leads with one iconic garment\n  D. WHAT-SHE-IS-NOT-WEARING — "No armor at all..." / "No cloak..." / "Sleeveless..."\n  E. LIVED-IN DETAIL — leads with wear/damage story\n  F. COLOR-PALETTE-LED — leads with chromatic identity\n\nDO NOT use a rigid "CULTURE-NAME — [garments list]" headline format. Mix openings, capitalization, lengths.\n\nABSOLUTE BANS (the cheesecake line — these stay banned):\n• NO "chainmail bikini" / "battle bikini" / "battle bra" / "string-strap outfit" / "underwear as armor"\n• NO "exposed cleavage as the focus" / "plunging low-cut neckline"\n• NO "harness across torso as outfit" / "bondage-coded"\n• NO "sultry" / "sensual" / "alluring" / "seductive" / "provocative"\n• NO artist names (Frazetta / Brom / Vallejo / Boris / Hildebrandt / Whelan)\n\nALLOWED + ENCOURAGED (per 2026-05-23 COOL ARMOR recalibration):\n• Ornate articulated plate / cuirass / scale / lamellar / chitin-and-hide / brigandine — fitted to female anatomy\n• Pauldrons / vambraces / greaves / gorget; hand-engraved, brass-riveted, runic-etched, blackened-steel\n• Fitted battle-leather / studded-leather / scout leathers with shoulder-harness + tooled bracers\n• Bare or partial arms when it reads WARRIOR (athletic, tattooed, harnessed) — NOT glamour\n• Cloak / half-cape as an ACCENT over armor, never the whole outfit\n• Belted/cinched to her form\n\nMUST READ AS: cool + fitted + ornate ARMOR, class-coded, HIGH FANTASY. NEVER frumpy drapes, NEVER glamour/cheesecake.\n\nCONTENT VARIETY MANDATE — every entry MUST differ in:\n• OUTFIT ARCHETYPE\n• MATERIAL PALETTE — oxblood / forest-green / charcoal / cobalt / verdigris-bronze / pewter / bone-white / wine-red / dark teal / saffron / russet / steel-grey / cream / sand-tan / indigo / olive / amber / coral-pink / jade / amethyst-purple\n• FANTASY-CANON CULTURE FLAVOR (one of):\n    • LOTR: Rohirrim / Gondorian / Dúnedain / Númenórean / Sindar / Noldor / Galadhrim / Haradrim / Easterling\n    • GoT: Northerner / Dornish / Highgarden / Ironborn / Free-Folk\n    • Skyrim: Nord / Imperial / Redguard / Bosmer / Altmer / Dunmer / Breton\n    • Witcher: Nilfgaardian / Skellige / School-of-Wolf / Aen Seidhe / Mahakaman\n    • D&D Forgotten Realms: Cormyrean / Waterdhavian / Thayan / Chultan / Calishite (avoid the strongest real-world coding; lean on fantasy-original names)\n    • Warcraft: Stormwind / Stranglethorn / Quel'Thalas / Ironforge / Hyjal\n    • Elden Ring / Dark Souls: Carian / Leyndell / Liurnia / Catarina\n    • Generic D&D: Drow / Elf / Dwarf / Halfling-Shire / Half-orc / Tiefling / Dragonborn\n• CLASS REGISTER — heavy-armored / mid-armored / lightly armored / robed / hide-and-fur / civilian\n• CLIMATE (per distribution above)`,
  ...
  female_warrior_action: {
    ...
    touchpoints: [
      ...
      'AT THE RUIN SHAFT — crouched at the rim of the ancient shaft, the anchored rope gripped in one fist, dust drifting around her, glowstone in mouth illuminating the moss-covered walls dropping away below',
