...
const POOL_RECIPES = {
  ...
  female_adventurer_outfit: {
    format: 'simple',
    theme: `SLEEK ADVENTURING GEAR for a female adventurer — practical, agile, functional, road-tested. Painterly fantasy concept-art tradition WITHOUT artist callouts. Each entry 20-50 words.\n\nSTRUCTURAL VARIETY IS MANDATORY — entries must NOT all follow the same shape. Mix these structural forms across the pool (target ~equal distribution):\n  A. SILHOUETTE-LED — leads with the overall shape ("Cropped riding jacket and high boots..." / "Layered desert wraps over fitted under-tunic..." / "Long leaf-green hooded cloak almost to the ankle...")\n  B. MATERIAL-LED — leads with the dominant fabric / metal ("Oiled black leather throughout — coat, gauntlets, boots — supple from years of road wear..." / "Verdigris bronze scale across the chest, mail beneath...")\n  C. SINGLE-PIECE FOCUS — leads with one iconic garment ("A weathered green Ranger-cloak with a fox-fur collar..." / "Steel cuirass engraved with sun-rays...")\n  D. WHAT-SHE-IS-NOT-WEARING — leads with absence ("No armor at all — just a fitted dark wool tunic, riding trousers, soft boots, an enchanter who fights with words and spell..." / "Sleeveless quilted gambeson, tattooed shoulders bare...")\n  E. LIVED-IN DETAIL — leads with a wear/damage story ("Patched leather coat with mismatched buttons, the elbows reinforced with darker hide where the original wore through..." / "Three sash-knots: one for each year on the road, dyed different colors...")\n  F. COLOR-PALETTE-LED — leads with the chromatic identity ("Bone-and-rust desert palette: sand linen, terracotta belt, faded crimson scarf..." / "Forest-pine-and-bark — every piece in dark green or umber...")\n\nDO NOT use the rigid "CULTURE-NAME — [garments list]" headline format. Mix capitalization, openings, lengths.\n\nABSOLUTE BANS (NSFW triggers):\n• NO "minimal coverage" / "battle bikini" / "battle bra" / "bare midriff" / "exposed cleavage" / "exposed thighs"\n• NO "form-fitting" / "skin-tight" / "second-skin"\n• NO "harness across torso" / "bondage-coded"\n• NO "sultry" / "sensual" / "alluring" / "seductive" / "provocative" / "curves emphasized" / "bust-accentuating" / "low-cut"\n• NO artist names (Frazetta / Brom / Vallejo / Boris / Hildebrandt / Whelan)\n\nMUST READ AS: functional + covered + road-tested + class-coded.\n\nCONTENT VARIETY MANDATE — every entry MUST differ from every other in:\n• OUTFIT ARCHETYPE — light traveler's clothes / quilted gambeson / leather brigandine / chainmail / lacquered scale / mage robes / monastic wraps / desert nomad layers / arctic furs / heavy plate / no-armor-at-all caster / hooded rogue coat / bardic doublet / druidic moss-and-leaf / dragonscale / hide-and-fur barbarian / paladin half-plate / scholar's coat / sea-captain's coat\n• MATERIAL PALETTE — oxblood / forest-green / charcoal / sand-bleached / cobalt / verdigris-bronze / pewter / bone-white / black / wine-red / dark teal / saffron / russet / steel-grey / midnight-blue\n• CULTURE FLAVOR — Rohirrim / Gondorian / Dúnedain / Númenórean / Witcher / Elven Sindar / Drow / Khazâd-dwarven / Bedouin-coded / Mongol-coded / Persian-coded / Norse-coded / samurai-coded / Aztec-coded / Celtic-coded / Egyptian-coded / Byzantine-coded / Slavic-coded\n• CLASS REGISTER — heavy-armored (paladin, knight) / mid-armored (warrior, ranger) / lightly armored (rogue, monk) / robed (mage, cleric, warlock) / hide-and-fur (druid, barbarian, shaman) / civilian (bard, artificer)`,
    touchpoints: [
      'Cropped dark leather riding jacket over a fitted linen blouse, breeches tucked into knee-high boots, no other armor — speed is her protection',
      'Pewter mail hauberk falling to mid-thigh, leather belt cinching at the waist, plain wool trousers, sturdy boots — utility before ornament',
      'Sand-bleached layered desert robes, indigo inner-wrap, a faded crimson headscarf wound to leave only her eyes visible',
      'Brushed-steel breastplate engraved with a single rising-sun motif over a quilted gambeson; everything else is plain — the cuirass is the whole statement',
      'A weathered forest-green hooded cloak almost to the ankle, fox-fur collar, beneath it a simple brown tunic and trousers',
      'Bone-white robes, voluminous sleeves, a wide red sash twisted twice around the waist — monastic, ankle-deep walking sandals',
      'Patched leather coat with mismatched horn buttons, elbows re-hided in darker leather, the original color long faded out',
      'Charcoal mage-coat with a high collar and silver-thread runic trim along the hem, otherwise unadorned — the magic is the ornament',
      'No armor — fitted dark velvet doublet over a cream shirt, riding trousers, low boots, a heavy spellbook on a baldric across her chest',
      'Black-iron banded scale across the chest, fur-trimmed collar, layered wool beneath, painted clan-marks on her cheekbones',
      'Light teal-and-gold layered robes of an eastern-coded scholar, brocade coat with a high stiff collar, soft turned-toe boots',
      'Heavy hide-and-fur overcloak that doubles as a bedroll, hardened leather chest-piece beneath, twin braided thongs at the throat',
      'Hammered bronze scale armor in the Khazâd tradition, geometric knotwork at the borders, beard-clasps echoed on her cuffs (she has no beard, the motif is family)',
      'A faded crimson velvet sash is the only color in an otherwise all-black ensemble — a memory of someone she lost on the road',
      'Quilted indigo armor coat in the samurai cut, white under-kimono peeking at the collar, black tabi boots',
      'Half-plate articulated steel from gorget to shin-guards, surcoat in the silver-tree of Gondor, dust-stained and weather-worn',
      'Layered moss-green druidic wraps with living vine-trim still alive and creeping along the seams, antler-clasp at the throat',
      'A sleeveless quilted gambeson exposing tattooed shoulders and forearms (clan-ink, not skin-display), heavy bracers, hide trousers',
      'Black spider-silk Drow traveling coat with a deep hood, the silk barely catching ambient light — designed to disappear',
      'Wine-red velvet bard\'s doublet, ivory linen shirt with full sleeves, soft boots, a tooled-leather lute-case across her back',
      'A travel-stained naval coat from Númenor, brass buttons tarnished by salt, a captain\'s cocked hat tucked under her arm',
      'Saffron-and-amber Aztec-coded quilted cotton armor, jaguar-pelt mantle across the shoulders, jade ear-plugs, painted face-stripes',
      'Forest-green felted wool against the mountain cold, hobnail boots, ice-axe strapped to her pack — equipment over fashion',
      'A simple grey scholar\'s coat to mid-thigh, ink-stained cuffs, a leather satchel of scrolls — she fights primarily by knowing where the enemy is',
      'Layered russet wool in the Rohirrim style, bronze scale pauldrons stamped with horse-motifs, a cloak that doubles as a saddle-blanket',
      'Charcoal road-coat, hooded, asymmetric — buttons up the right side, slit on the left for a quick-draw — rogue\'s cut',
    ],
  ...
  female_adventurer_action: {
    format: 'simple',
    theme: `STORY-RICH adventuring moments for a female adventurer in the wild — a candid mid-action beat from her travels. NOT mundane camp chores. NOT combat. Each moment is the kind of thing that opens a chapter — something is happening, someone is doing the thing they do. Each entry 25-45 words. Format: "ACTION-CAP — body position + specific prop or object + specific location detail + cinematic tension".\n\nABSOLUTE BANS:\n• NO combat / mid-strike / weapon-aimed-at-foe / enemy in frame / fallen body / wounded character / blood-fight\n• NO chores ("sharpening blade / polishing sword / lacing boots / drinking from waterskin / eating by campfire")\n• NO stock poses ("scanning horizon hand-to-brow / kneeling at shrine")\n• NO sultry / sensual / posing-for-camera language\n\nMANDATORY in every entry:\n• A STORYTELLING HOOK — something is happening, why it matters or what's at stake\n• A SPECIFIC PROP / OBJECT she's interacting with\n• A SPECIFIC LOCATION beat (forest path / cliff trail / cave mouth / clearing / stream-bank / etc.)\n• CINEMATIC TENSION — held breath, mid-motion, charged stillness, half-drawn focus\n\nVARIETY MANDATE — cover the spectrum across all adventurer classes:\n• TRACKING / SCOUTING: kneeling at print / examining broken twig / pressing palm to game-trail dust / following blood-trail through ferns / reading wind\n• EXPLORATION: rappelling into ruin / wading flooded passage / climbing partway up cliff / squeezing through narrow passage / lifting collapsed beam aside\n• MAGIC / RITUAL: mid-spell with hands cupped around glowing focus / casting ward-circle / consulting bone-runes / lighting protective sigil / channeling at standing stone / brewing potion over field-fire\n• DISCOVERY: brushing dust from carved sigil / lifting cloth from cache / unrolling map on flat rock / finding signet ring in dirt / opening sealed casket\n• TRAVEL: fording icy river / cresting hill on horseback / leading mount across a rope bridge / wading through marsh / pulling rein at a crossroads\n• LISTENING / WATCHING: pressed against tree-trunk gone silent / kneeling at game-trail listening / hand raised for silence behind her / freezing mid-step at distant sound\n• SHELTER: kindling small fire under rain-tarp / stringing up a hammock between branches / setting snares in a thicket / drawing water from a streamlet\n• CRAFT / WORK: fletching arrows at a flat rock / repairing tear in a cloak / setting traps / writing in a small journal at camp / consulting compass + map together`,
    touchpoints: [
      'TRACKING THROUGH FERN — kneeling at a half-print in damp loam, fingertip just brushing the edge, her eyes already following the trail into the deep ferns ahead',
      'CASTING WARD-CIRCLE — kneeling in chalk-drawn ring on flat stone, scattering bone-runes one by one, breath ghosting white in the suddenly-cold air around her',
      'MID-SPELL AT STANDING STONE — palms cupped open in front of her chest, a soft glow gathering between them, the ancient menhir at her shoulder etched with runes',
      'RAPPELLING INTO RUIN — descending knotted rope down a dark shaft, lantern hooked at her belt, stone walls slick with moss falling past her on either side',
      'FORDING ICY RIVER — knee-deep mid-stream with a steady hand on her mount\'s bridle, river-stones visible through black water, far bank still half-shrouded in dawn-mist',
      'EXAMINING CARVED SIGIL — kneeling at a half-buried stone slab in a forest clearing, gloved fingertip clearing moss from a rune that has begun to glow faintly under her touch',
      'BRUSHING DUST FROM CACHE — crouched at a half-uncovered cedar-box in cave-mouth shadow, palm sweeping centuries of grit aside, the box-latch already half-visible',
      'CONSULTING MAP AT CROSSROADS — kneeling at a flat stone with a vellum map spread out, one hand pinning a corner, the signpost above her marked in three weather-worn directions',
      'STRINGING THE BOW — one foot braced through the grip, both hands drawing the bowstring across the limb-nock, focus narrowed to the click of the string seating home',
      'PRESSING PALM TO TREE — pausing mid-stride against a great trunk, eyes shut, listening to something on the wind that her companion has not yet heard',
      'CASTING FROM FOCUS — arm half-extended with a glowing crystal held in her palm, a thin glyph of light blooming in the air above it, hair just beginning to lift in the magical wind',
      'DRAWING WATER AT STREAM — crouched at a clear pool, waterskin held under the flow, the other hand braced on a moss-covered rock, dragonflies above the water',
      'LIFTING COLLAPSED BEAM — both arms straining against a half-fallen rafter in a ruined hall, dust falling through a shaft of light from the broken roof above',
      'KINDLING FIRE UNDER TARP — kneeling in the lee of a stretched oilcloth in steady rain, sparking flint over a tinder-nest, the first flame just catching',
      'FLETCHING ARROW AT REST — seated cross-legged on a flat stone, a half-fletched shaft braced between her knees, a feather-vane held in steady fingers',
      'CRESTING THE RIDGE ON FOOT — one hand on a knee at the lip of a high pass, breath fogging in the thin air, the valley below opening into haze for the first time',
      'DECODING RUNE-WALL BY TORCHLIGHT — torch held high in one hand, the other tracing a glyph-line across a crypt antechamber wall, lips moving silently as she reads',
      'SETTING SNARE IN THICKET — kneeling among low brush with a fine wire-loop held between her fingertips, fixing it to a sapling, eyes already on the game-trail beside her',
      ...
      'CHANNELING AT FAMILIAR — kneeling beside her seated familiar (raven / cat / fox) with one hand resting on its back, eyes closed in shared concentration',
      'OPENING SEALED CASKET — kneeling at a small iron-bound casket on a flat stone, lifting the lid with both hands, lamplight catching on the contents inside',
      'PULLING REIN AT CROSSROADS — atop her dark mount in low evening light, gloved hand resting on the saddle pommel, head tipped to read a weather-worn signpost',
      'CLIMBING PARTWAY UP CLIFF — caught mid-grip three meters above a trail, both hands and one foot pressed to stone, focus narrowed to the next handhold',
      'STUDYING NIGHT SKY THROUGH SEXTANT — standing at the edge of a clearing, brass instrument raised to one eye, the other hand steadying it against her cheekbone',
      'WRITING IN JOURNAL AT CAMP — seated cross-legged in firelight with a small leather book open on one knee, quill moving in careful strokes, her mount grazing behind her',
      'BREWING POTION OVER FIELD-FIRE — kneeling at a small camp-pot suspended over flame, dropping a sprig of herb in with one hand while stirring with a wooden spoon',
      'HARVESTING HERB AT DAWN — kneeling beside a fern-cluster in low golden light, snipping a stem at the base with small bronze scissors, satchel open beside her',
      'FOLLOWING GLOW-MUSHROOM TRAIL — pausing in deep cave passage with a fungus-stem in her palm, the soft blue light catching her face, the trail of glow stretching ahead',
      'CONSULTING BONE-RUNES — crouched at a flat travel-stone with carved bones cast in a small pattern, fingertips tracing the spread, weather threatening behind her',
      'STILL AT THE EDGE OF CLEARING — caught mid-step in dappled forest light, hand half-raised in silent signal, listening to something the camera cannot see',
    ],
