...
Current values (2026-08-12): **`min_app_version = '1.0.15'`** and
**`latest_app_version = '1.0.15'`** — every client below 1.0.15 is HARD-blocked
...
```sql
UPDATE public.engine_config SET latest_app_version = '1.0.15';  -- after 1.0.15 is live
UPDATE public.engine_config SET min_app_version   = '1.0.15';   -- forces the upgrade
```
