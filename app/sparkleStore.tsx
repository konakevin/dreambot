      ...
      <ScrollView contentContainerStyle={s.scroll}>
        ...
        {isLoading ? (
          ...
          <View style={s.packRow}>
            {sorted.map((pkg) => (
              <PackCard key={pkg.identifier} pkg={pkg} onPurchase={handlePurchase} purchasing={purchasing} />
            ))}
          </View>
        )}
...
const s = StyleSheet.create({
  ...
  // Balance
  balanceCard: {
    alignItems: 'center', gap: 4, paddingVertical: 32,
  },
  balanceAmount: {
    color: colors.textPrimary, fontSize: 48, fontWeight: '800',
  },
  balanceLabel: {
  ...
  popularBadgeText: {
    color: '#000000', fontSize: 10, fontWeight: '800', letterSpacing: 0.5,
  },
  ...
  priceButton: {
    ...
    marginTop: 8, minWidth: 80, alignItems: 'center',
  },
  priceButtonFeatured: {
