...
// Wide actions — dynamic scene actions, character visible from front or side angle
const ACTIONS_WIDE: Entry[] = [
  { text: 'mid-leap across a chasm, body in full extension', weight: 6 },
  { text: 'swinging a weapon in a dramatic arc, caught mid-strike', weight: 6 },
  { text: 'casting a spell with energy crackling from outstretched hands', weight: 6 },
  { text: 'climbing a massive structure, one arm reaching for the next hold', weight: 5 },
  { text: 'surfing or riding a wave of energy through the environment', weight: 5, rarity: 'bold' },
  { text: 'standing at the edge of a cliff, wind whipping through clothes and hair', weight: 7 },
  { text: 'kneeling to examine something glowing on the ground', weight: 5 },
  { text: 'sprinting through the scene, mid-stride, coat or cape trailing', weight: 6 },
  { text: 'bracing against a powerful wind or blast, one arm shielding their face', weight: 5 },
  { text: 'reaching up toward something floating just out of grasp', weight: 5 },
  { text: 'sitting on a ledge with legs dangling, surveying the world below', weight: 6 },
  { text: 'playing an instrument, lost in the music', weight: 4 },
  { text: 'crouching in a combat-ready stance, tension in every muscle', weight: 5 },
  { text: 'caught mid-fall through the air, arms outstretched', weight: 4, rarity: 'bold' },
  { text: 'riding a massive creature, gripping its mane', weight: 5, rarity: 'bold' },
  { text: 'pulling open a massive ancient door with both hands', weight: 5 },
  { text: 'wading through waist-deep water, pushing against the current', weight: 5 },
  { text: 'standing triumphant atop a fallen structure, fist raised', weight: 5 },
  { text: 'dodging through a hail of debris, caught mid-dive', weight: 4, rarity: 'bold' },
  { text: 'reading from an ancient tome, bathed in its glow', weight: 4 },
  { text: 'balancing on a narrow beam high above the ground, arms outstretched', weight: 4 },
  { text: 'shielding someone smaller behind them, protective stance', weight: 4 },
  { text: 'taming a wild creature, one hand extended in calm', weight: 4, rarity: 'bold' },
  { text: 'meditating cross-legged as the world erupts around them', weight: 4, rarity: 'bold' },
  { text: 'launching into the air propelled by an explosion below', weight: 4, rarity: 'chaotic' },
  { text: 'sliding down a steep slope on their feet, sparks flying', weight: 4 },
  { text: 'catching a falling object mid-air, one-handed', weight: 4 },
  { text: 'dueling another figure, blades locked', weight: 5, rarity: 'bold' },
  { text: 'dancing alone in the rain, arms spread wide', weight: 4 },
  { text: 'holding a torch aloft, illuminating a massive cavern around them', weight: 5 },
];
