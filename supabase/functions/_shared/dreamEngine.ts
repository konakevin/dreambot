...
export const DREAM_MEDIUMS: DreamMedium[] = [
  ...
  // pencil_sketch removed — Flux can't render authentic pencil sketch style
  {
    ...
    label: 'Neon',
    directive:
      "Create images dominated by vibrant electric colors—cyan, magenta, electric blue, hot pink, and acid green—glowing intensely against deep black or dark purple backgrounds. Emphasize sharp, clean linework with geometric patterns and circuit-like designs. Surfaces should appear wet and highly reflective, creating mirror-like duplications of light sources. Incorporate atmospheric haze or fog to enhance light diffusion and create volumetric lighting effects. Use LED strip patterns, neon tube outlines, and blacklight fluorescence as primary illumination. Composition should feature strong contrast between brilliant glowing elements and void-like darkness. Textures should be sleek and synthetic—glass, chrome, wet concrete, and polished metals that catch and reflect neon light. Apply rim lighting and edge glow effects to objects. Include particle effects like light trails, digital glitches, and energy streams. The overall aesthetic should feel futuristic, cybernetic, and electric, reminiscent of Tron Legacy's digital world where light itself becomes architecture and design element.",
    fluxFragment:
      'neon lighting, cyberpunk aesthetic, electric glow, wet reflective surfaces, volumetric fog, LED strips, blacklight fluorescence, geometric patterns, rim lighting, dark background, synthetic textures',
  },
  {
    key: 'comic_book',
    label: 'Comic Book',
